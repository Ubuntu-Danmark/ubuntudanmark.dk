...
class mcp_warn
{
	...
	*/
	function mcp_warn_post_view($action)
	{
		...
		$avatar_img = get_user_avatar($user_row['user_avatar'], $user_row['user_avatar_type'], $user_row['user_avatar_width'], $user_row['user_avatar_height'], NULL, NULL, $user_row['user_email']);

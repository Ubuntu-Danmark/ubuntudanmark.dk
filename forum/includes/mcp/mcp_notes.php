...
class mcp_notes
{
	...
	*/
	function mcp_notes_user_view($action)
	{
		...
		$rank_title = $rank_img = '';
		$avatar_img = get_user_avatar($userrow['user_avatar'], $userrow['user_avatar_type'], $userrow['user_avatar_width'], $userrow['user_avatar_height'], NULL, NULL, $userrow['user_email']);

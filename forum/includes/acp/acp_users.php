	...
	function main($id, $mode)
	{
		...
		switch ($mode)
		{
			...
			case 'avatar':
				...
				$avatar_img = get_user_avatar($user_row['user_avatar'], $user_row['user_avatar_type'], $user_row['user_avatar_width'], $user_row['user_avatar_height'], 'USER_AVATAR', true, $user_row['user_email']);

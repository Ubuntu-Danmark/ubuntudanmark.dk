...
* @version $Id: install.php 484 2015-02-07 07:35:47Z jan_skovsgaard $
*
...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Du har nu konverteret dit board til phpBB 3.1. Du kan nu logge ind og <a href="../">tilgå dit board</a>. Kontroller venligst at alle indstillinger blev konverteret korrekt, inden du gør dit board tilgængeligt ved at slette install mappen. Husk at hjælp til brugen af phpBB 3.1 er tilgængelig online via <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">dokumentationen</a> og <a href="https://www.phpbb.com/community/viewforum.php?f=466">support foraene</a>.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Krævet</strong> - Du skal køre med minimum version 5.3.3 af PHP (PHP 7 er ikke understøttet) for at kunne installere phpBB. Hvis <var>safe mode</var> vises herunder, kører din PHP-installation i denne tilstand. Dette vil give begrænsninger i mulighederne for fjernadministration og lignende funktioner.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Dit oprindelige søgeindeks blev ikke konverteret. Udføres der i øjeblikket en søgning, vil den ikke give nogle resultater. For at oprette et nyt søgeindeks skal du i administratorkontrolpanelet vælge "Vedligehold" og "Søgeindeks" i undermenuen.',
...
$lang = array_merge($lang, array(
	...
	'FILES_VERSION'					=> 'Version af filer',
	...
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>Ukomplet opdatering</h1>
		...
		<p>Vi bemærkede at den seneste opdatering af din phpBB-installation ikke blev fuldført. Klik på <a href="%1$s" title="%1$s">database_update scriptet</a> for at køre dette. Hvis scriptet mangler, bedes du <a href="https://www.phpbb.com/downloads/" title="phpBB downloads">downloade din pakkeversion</a>, og uploade "install"-mappen til roden af din phpBB-mappe (der hvor din config.php-fil også er) og <a href="%1$s" title="%1$s">kør databaseopdateringsscriptet</a>.</p>',

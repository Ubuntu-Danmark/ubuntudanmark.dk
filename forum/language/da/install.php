...
* @version $Id: install.php 296 2013-07-19 07:35:46Z jan_skovsgaard $
...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Du har nu konverteret dit board til phpBB 3.0. Du kan nu logge ind og <a href="../">tilgå dit board</a>. Kontroller venligst at alle indstillinger blev konverteret korrekt, inden du gør dit board tilgængeligt ved at slette install mappen. Husk at hjælp til brugen af phpBB 3.0 er tilgængelig online via <a href="https://www.phpbb.com/support/documentation/3.0/">dokumentationen</a> og <a href="https://www.phpbb.com/community/viewforum.php?f=46">support foraene</a>.',
	...
	<p>Klik på knappen nedenfor som leder dig til administratorkontrolpanelets (ACP) statistiske data. Vi vil sætte stor pris på hvis du vil dele disse data med os. Efterfølgende bør du give dig tid til at gennemgå de indstillinger du har til rådighed i ACP. Husk at der er hjælp at hente online via den engelske <a href="https://www.phpbb.com/support/documentation/3.0/">dokumentation</a>, i <a href="%3$s">README</a> og i <a href="https://www.phpbb.com/community/viewforum.php?f=46">supportforaene</a>.</p><p><strong>Slet, flyt eller omdøb venligst nu install-mappen før du bruger dit board. Hvis denne mappe stadig er til stede, vil kun administratorkontrolpanelet (ACP) være tilgængeligt.</strong>',
	...
	'SUPPORT_BODY'				=> 'Der ydes fuld gratis support til denne stabile frigivelse af phpBB3. Supporten inkluderer: </p> <ul><li>installation</li><li>konfiguration</li><li>tekniske spørgsmål</li><li>problemer relateret til potentielle fejl i softwaren</li><li>opdatering fra release candidate-versioner (RC) til den senest stabile version</li><li>konvertering fra phpBB 2.0.x til phpBB3</li><li>konvertering fra andre boardsystemer til phpBB3 (se venligst <a href="https://www.phpbb.com/community/viewforum.php?f=65">Convertors Forum</a>)</li></ul><p>Vi opfordrer brugere, der stadig anvender Beta-versioner af phpBB3, til at erstatte installationen med en frisk kopi af den seneste version.</p><h2>MODs og typografier</h2><p>Spørgsmål angående MODs bedes stillet i <a href="https://www.phpbb.com/community/viewforum.php?f=81">Modifications Forum</a>.<br />Spørgsmål angående typografier, skabeloner og billedpakker bedes stillet i <a href="https://www.phpbb.com/community/viewforum.php?f=80">Styles Forum</a>.<br /><br />Angår dit spørgsmål en bestemt pakke, bedes du indsende det direkte i emnet omhandlende denne pakke.</p><h2>Få support</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">phpBB velkomstpakken</a><br /><a href="https://www.phpbb.com/support/">Support Section</a><br /><a href="https://www.phpbb.com/support/documentation/3.0/quickstart/">Engelsk Quick Start Guide</a><br /><br />Hvis du <a href="https://www.phpbb.com/support/">tilmelder dig vores mailingliste</a> sikrer du, at du bliver holdt opdateret med de seneste nyheder og frigivelser.<br /><br />',

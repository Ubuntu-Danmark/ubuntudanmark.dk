...
$lang = array_merge($lang, array(
	'ACL_U_MY_ACC_POST_DELETE'	=> 'Zezwól na skasowanie postów, podczas usuwania konta',

	'UCP_PROFILE_MY_ACC_DELETE'	=> 'Usuń swoje konto',

	'LOG_MY_ACC_DELETE'			=> '<strong>Usunięto  konto</strong><br />» %s',
	'LOG_MY_ACC_POST_DELETE'	=> '<strong>Usunięto konto, oraz posty</strong><br />» %s',
));
 ...
 */
function wp2bb_submit_post($auth, &$user, $subject, $username, $usercolor, $posttime, &$poll, &$data, $update_message = true) {
    ...
    $subject = $subject;
    $data['topic_title'] = $data['topic_title'];
...
function wp2bb_generate_text_for_storage(&$text, &$uid, &$bitfield, &$flags, $allow_bbcode = false, $allow_urls = false, $allow_smilies = falsetio) {

...
// $base sanity check.
if ( 'BASE' == $base )
	die( /*WP_I18N_BASE_ERROR*/'Opsætningfejl i <code>wp-config.php</code>. <code>$base</code> er sat til <code>BASE</code>, men det burde være noget i retning af <code>/</code> eller <code>/blogs/</code>.'/*/WP_I18N_BASE_ERROR*/ );
...
if ( !isset( $current_site ) || !isset( $current_blog ) ) {
	...
	if ( false !== strpos( $domain, ':' ) ) {
		if ( substr( $domain, -3 ) == ':80' ) {
			...
			wp_die( /*WP_I18N_NO_PORT_NUMBER*/'Multisite virker kun, hvis der ikke er portnumre i URL&#39;en.'/*/WP_I18N_NO_PORT_NUMBER*/ );
		}
	}
	...
	if ( ! $blog_id ) {
		if ( defined( 'WP_INSTALLING' ) ) {
			...
			wp_die( /*WP_I18N_NO_BLOG*/'Der findes intet websted med dette navn i dette netværk.'/*/WP_I18N_NO_BLOG*/ . $msg );
		}
	}
}

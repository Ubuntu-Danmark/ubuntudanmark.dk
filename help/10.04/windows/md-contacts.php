...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kontakter-/Adressebog</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kontakter-/Adressebog</h1>
              <div class="entry-content">
                <div class="sect1" title="Kontakter-/Adressebog">
                  <p>Hvis du har gemt din adressebog fra Windows, kan du nu importere dine kontaktpersoner i <span class="application"><strong>Evolution</strong></span>. De følgende instruktioner antager, at du vil importere adressekartoteket fra <span class="application"><strong>Microsoft Outlook Express 6</strong></span> eller <span class="application"><strong>Microsoft Outlook 2002</strong></span>:</p>
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      ...
                      <li class="listitem">
                        <p>Tryk på feltet ud for <em class="guilabel">Filnavn:</em>, hvorpå der står <span class="guibutton"><strong>(Ingen)</strong></span>. Find den mappe som du har gemt din adressebog i og åbn den.</p>
                      </li>
                      <li class="listitem">
                        <p>Vælg sikkerhedskopien af din adressebog og tryk <span class="guibutton"><strong>Åbn</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">vCard (.vcf, .gcrd)</em> eller <em class="guilabel">Outlook CSV eller Tab (.csv, .tab)</em>, fra <em class="guilabel">Filtype</em> listen, afhængig af hvilket format du har gemt din adressebog i. Tryk på <span class="guibutton"><strong>Næste</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Vælg en placering hvor kontakterne skal gemmes, såsom <span class="guimenuitem">På denne maskine</span> → <span class="guimenuitem">Personlig</span>. Tryk <span class="guibutton"><strong>Næste</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Tryk på <span class="guibutton"><strong>Importér</strong></span> for at importere kontakterne til <span class="application"><strong>Evolution</strong></span>. Når importen er færdig, vil de importerede kontaktpersoner være umiddelbart tilgængelige.</p>
                      </li>
                    </ol>
                  </div>
                </div>

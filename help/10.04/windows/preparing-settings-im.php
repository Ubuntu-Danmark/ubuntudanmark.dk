...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Chatindstillinger</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Chatindstillinger</h1>
              <div class="entry-content">
                <div class="sect1" title="Chatindstillinger">
                  <p>Hvis du bruger chat (instant messaging) software, vil du have oprettet en brugerkonto på et chatnetværk. Ubuntu har glimrende understøttelse af mange chatkonto fra start af, så du vil stadig være i stand til at bruge din eksisterende konto, efter du har skiftet. Sørg for, at du laver en note af følgende oplysninger om dit chat-konto:</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      ...
                      <li class="listitem">
                        <p>Brugernavn eller alias</p>
                      </li>
                    </ul>
                  </div>
                  <p>Hvis muligt, så opret også en kopi af din venne- eller kontakt-liste.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Browser-bogmærker/foretrukne</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Browser-bogmærker/foretrukne</h1>
              <div class="entry-content">
                <div class="sect1" title="Browser-bogmærker/foretrukne">
                  <p>Hvis du gemte en listen over foretrukne websider fra den browser du brugte på Windows, kan du nu importere dem i webbrowsere til rådighed med Ubuntu. De følgende instruktioner er beregnet til brugere af standard webbrowseren <span class="application"><strong>Firefox</strong></span>, der importerer deres favoritter fra <span class="application"><strong>Microsoft Internet Explorer 6</strong></span>. Læs <a class="xref" href="preparing-bookmarks.html" title="Bogmærker fra netbrowser">“Bogmærker fra netbrowser”</a> for yderligere information.</p>
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      <li class="listitem">
                        <p>Tryk på <span class="guimenu">Programmer</span> → <span class="guisubmenu">Internet</span> → <span class="guimenuitem">Firefox Web Browser</span> for at starte <span class="application"><strong>Firefox Web Browseren</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Tryk på <span class="guimenuitem">Bogmærker</span> → <span class="guimenuitem">Arranger bogmærker…</span> for at starte <span class="application"><strong>Håndteringen af bogmærker</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Tryk på <span class="guimenuitem">Funktioner</span> → <span class="guimenuitem">Importer HTML...</span> og vælg <em class="guilabel">en HTML-fil...</em>, tryk derefter på <span class="guibutton"><strong>Næste</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Find og vælg den fil, som du oprindeligt eksporterede fra <span class="application"><strong>Internet Explorer</strong></span> (se <a class="xref" href="preparing-bookmarks.html" title="Bogmærker fra netbrowser">“Bogmærker fra netbrowser”</a>) og tryk <span class="guibutton"><strong>Åbn</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Din liste over foretrukne websider bliver tilføjet i <span class="application"><strong>Firefox</strong></span>.</p>
                      </li>
                    </ol>
                  </div>
                </div>

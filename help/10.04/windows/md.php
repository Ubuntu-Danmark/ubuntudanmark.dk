...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 2. Overførsel af dine data til Ubuntu</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 2. Overførsel af dine data til Ubuntu</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 2. Overførsel af dine data til Ubuntu">
                  <p>Dette kapitel indeholder instruktioner om hvordan du importerer dine data fra Windows-programmer til de tilsvarende Ubuntu programmer. Instruktionerne antager, at du vil bruge standard samlingen af programmer der installeret med Ubuntu og har fulgt instruktionerne i <a class="xref" href="preparing.html" title="Kapitel 1. Forberedelse til skiftet">Kapitel 1, <i>Forberedelse til skiftet</i></a> kapitlet.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title>Sæt en firewall op</title>
                ...
                <div class="sect1" title="Sæt en firewall op">
                  ...
                  <div class="sect2" title="Firewall konfigurationsværktøjer">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="id378933"></a>Firewall konfigurationsværktøjer</h3>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="sect2" title="Test af firewallen og overvågning af netværkstrafik">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="id379161"></a>Test af firewallen og overvågning af netværkstrafik</h3>
                        </div>
                      </div>
                    </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Tildel en separat brugerkonto til hver person</title>
    ...
    <link rel="prev" href="passwords.php" title="Adgangskoder" />
    <link rel="next" href="updates.php" title="Hold din software opdateret" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Tildel en separat brugerkonto til hver person</h1>
              <div class="entry-content">
                <div class="sect1" title="Tildel en separat brugerkonto til hver person">
                  <p>Når Ubuntu er nyinstalleret er systemet sat op til, at én person bruger det. Hvis mere end en person vil bruge computeren, er det bedst for hver person at have deres egen brugerkonto. På den måde kan de have separate indstillinger, dokumenter og andre filer. Om nødvendigt kan filerne også beskyttes mod at blive gennemset eller ændret af ikke-administratorer.</p>
                  <p>For at sætte brugerkonti op, vælg <span class="guimenu">System</span> → <span class="guimenuitem">Administration</span> → <span class="guimenuitem">Brugere og grupper</span>. Du skal være en <a class="ulink" href="../administrative/" target="_top">administrator</a> for at gøre dette.</p>
                  <p>Se <a class="ulink" href="http://library.gnome.org/users/users-admin/2.30/" target="_top">manualen til Brugerindstillinger</a> for yderligere oplysninger om oprettelse af brugerkonti.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Yderligere information</title>
    ...
    <link rel="prev" href="compiz-problems.php" title="Almindelige problemer" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Yderligere information</h1>
              <div class="entry-content">
                <div class="sect1" title="Yderligere information">
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>Se <a class="ulink" href="http://wiki.compiz-fusion.org/" target="_top">Compiz-Fusions dokumentationswebside</a> for yderligere information om avanceret konfiguration af visuelle effekter.</p>
                      </li>
                    </ul>
                  </div>
                </div>

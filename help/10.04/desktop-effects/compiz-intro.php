...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Hvad er visuelle effekter?</title>
    ...
    <link rel="prev" href="index.php" title="Visuelle effekter" />
    <link rel="next" href="compiz-configure.php" title="Konfigurering af visuelle effekter" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Hvad er visuelle effekter?</h1>
              <div class="entry-content">
                <div class="sect1" title="Hvad er visuelle effekter?">
                  <p>Ubuntu inkluderer specielle visuelle effekter, der er beregnet til at gøre din computer både sjovere og lettere at bruge. Heriblandt gennemsigtige vinduer, 3D-muligheder, skyggeeffekter, bevægelseseffekter og andre former for animationer.</p>
                  <p>Visuelle effekter er aktiveret som standard, men det er ikke nødvendigt at have dem aktiveret.</p>
                  <p>Hvis de visuelle effekter er deaktiveret, understøtter dit grafikkort det muligvis ikke. Prøv at <a class="link" href="compiz-configure.php" title="Konfigurering af visuelle effekter">aktivere dem manuelt</a> for at se om dette er årsagen.</p>
                </div>
              </div>
            </div>
          </div>

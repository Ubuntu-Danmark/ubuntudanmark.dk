...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Find mere information/hjælp</title>
    ...
    <link rel="prev" href="updates.php" title="Hold dig opdateret" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Find mere information/hjælp</h1>
              <div class="entry-content">
                <div class="section" title="Find mere information/hjælp">
                  <p>
                    <span class="inlinemediaobject">
                      <img src="../libs/img/gnome-help.png" />
                    </span>
                  </p>
                  <p>Ubuntu indeholder et omfattende hjælpesystem. Klik <span class="guimenu">System</span> → <span class="guimenuitem">Hjælp og support</span> for at tilgå det.</p>
                  <p>Hvis du ikke kan finde svaret der, vil du muligvis finde den <a class="ulink" href="https://help.ubuntu.com/community/UserDocumentation" target="_top">fældeskabs bidraget dokumentation hjemmeside</a> hjælpsom.</p>
                  <p>Hvis du ikke kan finde svar i dokumentationen, er der et omfattende fællesskab af frivillige, som yder gratis support. Se <a class="ulink" href="http://www.ubuntu.com/support/free" target="_top">Ubuntu hjemmeside</a> for de forskellige muligheder.</p>
                  <p>Canonical udbyder <a class="ulink" href="http://www.ubuntu.com/support/paid" target="_top">kommerciel teknisk support</a>, hvis du ønsker professionel support.</p>
                </div>
              </div>
            </div>
          </div>

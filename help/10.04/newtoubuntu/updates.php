...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Hold dig opdateret</title>
    ...
    <link rel="prev" href="music-video.php" title="Afspil musik og videoer" />
    <link rel="next" href="help.php" title="Find mere information/hjælp" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Hold dig opdateret</h1>
              <div class="entry-content">
                <div class="section" title="Hold dig opdateret">
                  <p>
                    <span class="inlinemediaobject">
                      <img src="../libs/img/update-manager.png" />
                    </span>
                  </p>
                  <p>Ubuntu leverer automatisk sikkerheds opdatering og andre opdateringer til din software.</p>
                  <p>Når sikkerhedsopdateringer er tilgængelige, vil <span class="application"><strong>Opdateringshåndteringen</strong></span> automatisk starte. Du vil blive noteret, om andre opdateringer, en gang om ugen. Hvis du vil installere opdateringer, skal du blot klikke <span class="guibutton"><strong>Installér opdateringer</strong></span> og indtaste din adgangskode, når du bliver bedt om det.</p>
                    ...
                    <table border="0" summary="Tip">
                      ...
                      <tr>
                        <td align="left" valign="top">
                          <p>Afhængig af de programmer der er blevet opdateret, er det muligt du vil blive bedt om at genstarte dit system.</p>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="note" title="Bemærk" style="margin-left: 0.5in; margin-right: 0.5in;">
                    <table border="0" summary="Note">
                      ...
                      <tr>
                        <td align="left" valign="top">
                          <p>Se <a class="ulink" href="../keeping-safe/" target="_top">Hold din computer sikker</a>, for at læse mere om at holde din computer opdateret og andre computersikkerhedstips. Læs mere om, hvordan programmer håndteres i Ubuntu under <a class="ulink" href="../add-applications/" target="_top">Tilføj, fjern og opdatér programmer</a>.</p>
                        </td>
                      </tr>
                    </table>
                  </div>

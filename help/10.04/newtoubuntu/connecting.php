...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Opretter forbindelse til internettet</title>
    ...
    <link rel="prev" href="applications.php" title="Programmer til forskellige opgaver" />
    <link rel="next" href="add-applications.php" title="Tilføj programmer" />
    <style type="text/css">
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Opretter forbindelse til internettet</h1>
              <div class="entry-content">
                <div class="section" title="Opretter forbindelse til internettet">
                  <p>Det er let at håndtere din internet forbindelse med <span class="application"><strong>Netværkshåndtering</strong></span>.</p>
                  <p>Ikonet for <span class="application"><strong>Netværkshåndtering</strong></span> i statusfelt, øverst til højre på dit skrivebord, viser dig status for din netværksforbindelse og gør dig i stand til at til- eller frakoble. Klik på ikonet for valgmuligheder.</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p><span class="inlinemediaobject"><img src="../libs/img/gnome-netstatus-disconn.png" /></span> <span class="emphasis"><em>Forbindelse afbrudt</em></span></p>
                      </li>
                      <li class="listitem">
                        <p><span class="inlinemediaobject"><img src="../libs/img/network-wired.png" /></span> <span class="emphasis"><em>Kablet netværk forbundet</em></span></p>
                      </li>
                      <li class="listitem">
                        <p><span class="inlinemediaobject"><img src="../libs/img/network-wireless.png" /></span> <span class="emphasis"><em>Trådløst netværk forbundet</em></span></p>
                      </li>
                    </ul>
                  </div>
                    ...
                    <table border="0" summary="Tip">
                      ...
                      <tr>
                        <td align="left" valign="top">
                          <p>Se <a class="ulink" href="../internet/" target="_top">Internet og netværk</a>, for mere information eller fejlfinding.</p>
                        </td>
                      </tr>
                    </table>
                  </div>

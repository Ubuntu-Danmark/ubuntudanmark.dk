...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Udfør kommandoer med særlige rettigheder</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Udfør kommandoer med særlige rettigheder</h1>
              <div class="entry-content">
                  <p>De følgende kommandoer behøver kommandoen <span class="command"><strong>sudo</strong></span> som præfiks. Se venligst <a class="ulink" href="https://help.ubuntu.com/community/RootSudo" target="_top">RootSudo</a> for information om brug af <span class="command"><strong>sudo</strong></span>.</p>
                  <div class="sect2" title="Tilføj en ny gruppe">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="add-group"></a>Tilføj en ny gruppe</h3>
                        </div>
                      </div>
                    </div>
                    <p>Kommandoen <span class="command"><strong>addgroup</strong></span> bruges til at oprette en ny gruppe på systemet. For at oprette en ny gruppe skal du skrive: </p>
                    <code class="screen">addgroup nygruppe</code>
                    <p> Ovenstående kommando vil oprette en ny gruppe kaldet <span class="strong"><strong>nygruppe</strong></span>.</p>
                  </div>
                  <div class="sect2" title="Tilføj en ny bruger">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="add-user"></a>Tilføj en ny bruger</h3>
                        </div>
                      </div>
                    </div>
                    <p>Kommandoen <span class="command"><strong>adduser</strong></span> bruges til at oprette en ny bruger på systemet. For at oprette en ny bruger skal du skrive: </p>
                    <code class="screen">adduser nybruger</code>
                    <p> Ovenstående kommando vil oprette en ny bruger kaldet <span class="strong"><strong>nybruger</strong></span>.</p>
                    <p>For at tilføje et kodeord for den nye bruger skal du bruge kommandoen <span class="command"><strong>passwd</strong></span>: </p>
                    <code class="screen">passwd nybruger</code>
                    <p>Til sidst kan du tilknytte den nye bruger til den nye gruppe ved at skrive: </p>
                    <code class="screen">adduser newuser newgroup</code>
                </div>
              </div>
            </div>
          </div>

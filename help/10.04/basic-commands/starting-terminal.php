...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Start en terminal</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Start en terminal</h1>
              <div class="entry-content">
                <div class="sect1" title="Start en terminal">
                  <p>Vælg <span class="guimenu">Programmer</span> → <span class="guimenuitem">Tilbehør</span> → <span class="guimenuitem">Terminal</span> for at åbne en <span class="application"><strong>terminal</strong></span>.</p>
                </div>
              </div>
            </div>
          </div>

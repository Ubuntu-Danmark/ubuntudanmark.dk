...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 3. At bruge et program når det er installeret</title>
    ...
    <link rel="prev" href="installing.php" title="Kapitel 2. At installere software" />
    <link rel="next" href="removing.php" title="Kapitel 4. At fjerne software" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 3. At bruge et program når det er installeret</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 3. Using a program once it’s installed">
                  <p>De fleste installerede programmer optræder under menuen <span class="guimenu">Programmer</span> i hjørnet af skærmen, i den samme kategori som de kom fra i Softwarecenteret.</p>
                  <p>For eksempel, hvis du installerede et program fra afdelingen <em class="guilabel">Kontor</em>, vil den optræde i <span class="guimenu">Programmer</span> → <span class="guisubmenu">Kontor</span>.</p>
                  <p>Værktøjer til at ændre indstillinger kan optræde under <span class="guimenu">System</span> → <span class="guisubmenu">Indstillinger</span> eller <span class="guimenu">System</span> → <span class="guisubmenu">Administration</span>.</p>
                  <p>Hvis du bruger Ubuntu Netbook Edition, vil et program optræde i dens kategori på hjemmeskærmen.</p>
                  <p>Nogle emner, såsom medieafspilning eller webbrowser-udvidelser, optræder ikke i menuerne. De bliver automatisk brug når Ubuntu har brug for dem. For webbrowser-udvidelser, kan det være nødvendigt at lukke browseren og genåbne den, før udvidelsen vil blive brugt.</p>
                </div>
              </div>
            </div>
          </div>

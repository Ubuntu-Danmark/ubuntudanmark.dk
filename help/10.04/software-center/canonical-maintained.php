...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 6. Hvad er “Canonical-vedligeholdt”?</title>
    ...
    <link rel="prev" href="metapackages.php" title="Kapitel 5. Hvorfor beder den mig om at fjerne flere programmer på en gang?" />
    <link rel="next" href="canonical-partners.php" title="Kapitel 7. Hvad er “Canonical Partners”?" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 6. Hvad er “Canonical-vedligeholdt”?</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 6. What is “Canonical-maintained”?">
                  <p>Noget af den software der er tilgængelig i Ubuntu Softwarecenter er vedligeholdt af Canonical. Canonical ingeniører garanterer at sikkerhedsrettelser og andre kritiske opdateringer udbydes til disse programmer.</p>
                  <p>Andet software er vedligeholdt af Ubuntu udviklerfællesskabet. Alle opdateringer blive udgivet efter bedste formåen.</p>
                </div>
              </div>
            </div>
          </div>

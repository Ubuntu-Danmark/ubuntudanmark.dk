...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 1. Hvad er Ubuntu Softwarecenter?</title>
    ...
    <link rel="prev" href="index.php" title="Ubuntu Softwarecenter" />
    <link rel="next" href="installing.php" title="Kapitel 2. At installere software" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 1. Hvad er Ubuntu Softwarecenter?</h1>
              <div class="entry-content">
		<div>
                  <p>Ubuntu Softwarecenter er et virtuelt katalog over tusinder af gratise programmer og andet software, der gør din Ubuntu computer mere funktionel.</p>
                  <p>Du kan finde software efter kategori eller ved søgning, og du kan installere et stykke software med et klink på en knap.</p>
                  <p>Softwarecenteret giver dig også mulighed for gennemse det software der allerede er installeret, og fjerne hvad du ikke længere har brug for.</p>
                </div>
              </div>
            </div>
          </div>

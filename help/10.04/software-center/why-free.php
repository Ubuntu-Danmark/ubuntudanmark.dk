...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 8. Hvor for er alle programmerne gratis?</title>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 8. Hvor for er alle programmerne gratis?</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 8. Hvor for er alle programmerne gratis?">
                  <p>På nuværende tidspunkt er alt software i Ubuntu Softwarecenteret gratis.</p>
                  <p>Det meste af denne software er udviklet som <em class="firstterm">open source</em>, hvilket betyder at alle har lov til at ændre det og genudgive det for en vilkårlig pris. Ubuntu-udviklere, Debian-udviklere, og andre pakker softwaren der er tilgængelig i Ubuntu Softwarecenteret, og gør den gratis tilgængelig for dig.</p>
                  <p>I en fremtidig udgave af Ubuntu, vil softwarecenteret også muliggøre køb af software.</p>
                </div>
              </div>
            </div>
          </div>

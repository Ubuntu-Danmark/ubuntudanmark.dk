...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 7. Hvad er “Canonical Partners”?</title>
    ...
    <link rel="prev" href="canonical-maintained.php" title="Kapitel 6. Hvad er “Canonical-vedligeholdt”?" />
    <link rel="next" href="why-free.php" title="Kapitel 8. Hvor for er alle programmerne gratis?" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 7. Hvad er “Canonical Partners”?</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 7. Hvad er “Canonical Partners”?">
                  <p><em class="guilabel">Canonical Partners</em> viser software fra udbydere, som har arbejdet sammen med Canonical, med at gøre deres software tilgængelig for Ubuntu.</p>
                  <p>Du kan installere denne software på samme måde som alt andet software i Ubuntu.</p>
                </div>
              </div>
            </div>
          </div>

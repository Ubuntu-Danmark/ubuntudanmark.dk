        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Søg i hjælp for Ubuntu 10.04 LTS</h1>
		    ...
		    var customSearchControl = new google.search.CustomSearchControl('015998855381345460959:lacahfqfodo');

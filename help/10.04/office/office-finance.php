...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Finansprogrammer</title>
    ...
    <link rel="prev" href="office-dtp.php" title="DTP og tegneprogrammer" />
    <link rel="next" href="office-document-templates.php" title="Anskaffelse af dokumentskabeloner" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Finansprogrammer</h1>
              <div class="entry-content">
                <div class="sect1" title="Finansprogrammer">
                  <p>
                    <span class="emphasis">
                      <em>Finansprogrammer giver dig mulighed for at holde styr på dine udgifter og administrere dine konti.</em>
                    </span>
                  </p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p><span class="strong"><strong><span class="application"><strong>GnuCash</strong></span></strong></span> er et program til at administrere dine personlige eller forretningsmæssige finanser.</p>
                        <p>Med <span class="application"><strong>GnuCash</strong></span> kan du holde styr på dine bankkonti, aktier, indtægter og udgifter. Hurtig og intuitiv som et checkhæfteregister, det er baseret på professionelle regnskabsprincipper for at sikre et afbalanceret regnskab og præcise rapporter.</p>
                        <div class="itemizedlist">
                          <ul class="itemizedlist" type="circle">
                            <li class="listitem">
                              <p>For yderligere information, se <a class="ulink" href="http://www.gnucash.org/" target="_top">hjemmesiden for GnuCash</a>.</p>
                            </li>
                            <li class="listitem">
                              <p>For at starte <span class="application"><strong>GnuCash</strong></span>, tryk på <span class="guimenu">Programmer</span> → <span class="guimenuitem">Kontor</span> → <span class="guimenuitem">GnuCash Finance Management</span>.</p>
                            </li>
                          </ul>
                        </div>
                      </li>
                      <li class="listitem">
                        <p><span class="strong"><strong><span class="application"><strong>HomeBank</strong></span></strong></span> er et personlige regnskabsprogram som er nemt at gå til.</p>
                        <p>Det kan hjælpe dig med at følge dine udgifter på tværs af flere bankkonti og kan lave informative diagrammer over indtægter og udgifter.</p>
                        <div class="itemizedlist">
                          <ul class="itemizedlist" type="circle">
                            <li class="listitem">
                              <p>For yderligere information, se <a class="ulink" href="http://homebank.free.fr/" target="_top">hjemmesiden for HomeBank</a>.</p>
                            </li>
                            <li class="listitem">
                              <p>For at starte <span class="application"><strong>HomeBank</strong></span>, tryk på <span class="guimenu">Programmer</span> → <span class="guimenuitem">Kontor</span> → <span class="guimenuitem">HomeBank</span>.</p>
                            </li>
                          </ul>
                        </div>
                      </li>

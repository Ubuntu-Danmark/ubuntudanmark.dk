...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="next" href="office-suites.php" title="Kontorpakker" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kontor</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Kontor" lang="da">
                  <p>Ubuntu leveres med en mængde software til at udføre kontoropgaver med såsom tekstbehandling og -udgivelse, regneark og præsentationer.</p>
                </div>
              </div>
            </div>
          </div>

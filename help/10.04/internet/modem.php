...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 6. Modemmer</title>
    ...
    <link rel="prev" href="troubleshooting-keyring.php" title="Hvorfor spørger Gnome Nøglering om min adgangskode hver gang jeg logger ind?" />
    <link rel="next" href="modem-identify.php" title="Identificer dit modem" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 6. Modemmer</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 6. Modemmer">
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Windows-deling</title>
    ...
    <link rel="prev" href="connecttoserver-ssh.php" title="SSH" />
    <link rel="next" href="connecttoserver-webdav.php" title="WebDAV (HTTP)" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Windows-deling</h1>
              <div class="entry-content">
                <div class="sect1" title="Windows-deling">
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      ...
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">Windows delt mappe</em> fra <em class="guilabel">Tjenestetype</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Indtast serverens adressen i <em class="guilabel">Server</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Indtast <em class="guilabel">Port</em>, <em class="guilabel">Mappe</em> og <em class="guilabel">Domænenavn</em> hvis nødvendigt. Dette er valgfrit.</p>
                      </li>
                      <li class="listitem">
                        <p>Udfyld <em class="guilabel">Brugernavn</em>. Du kan indtaste et domæne og brugernavn i følgende format: DOMÆNE\brugernavn.</p>
                      </li>
                      <li class="listitem">
                      ...
                      <li class="listitem">
                        <p>Du vil blive bedt om en adgangskode om nødvendigt.</p>
                      </li>
                    </ol>
                  </div>
                </div>

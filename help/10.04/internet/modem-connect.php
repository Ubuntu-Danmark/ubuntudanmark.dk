...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Opkobling med et modem</title>
    ...
    <link rel="up" href="modem.php" title="Kapitel 6. Modemmer" />
    <link rel="prev" href="modem-identify.php" title="Identificer dit modem" />
    <link rel="next" href="connecttoserver.php" title="Kapitel 7. Forbind til en server" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Opkobling med et modem</h1>
              <div class="entry-content">
                <div class="sect1" title="Opkobling med et modem">
                  <p>Netværkshåndteringen understøtter i øjeblikket ikke modem-forbindelser, så du bliver nødt til at installere den. Se <a class="ulink" href="apt:gnome-network-admin" target="_top">installere pakken gnome-network-admin</a>. Hvis du ikke har nogen fungerende internetforbindelse, så må du anskaffe dig denne pakke og installere den, se <a class="ulink" href="../add-applications/#installing-deb" target="_top">Hent og installér en .deb-pakke</a> for yderligere information.</p>
                  <div class="important" title="Vigtigt" style="margin-left: 0.5in; margin-right: 0.5in;">
                    <table border="0" summary="Important">
                      <tr>
                        <td rowspan="2" align="center" valign="top" width="25">
                          <img alt="[Vigtigt]" src="../libs/admon/important.png" />
                        </td>
                        <th align="left"></th>
                      </tr>
                      <tr>
                        <td align="left" valign="top">
                          <p>Du for brug for følgende oplysninger:</p>
                          <p>Internetudbyderens telefonnummer, brugernavn, kodeord, samt adresser for domænenavneservere.</p>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Åbn <span class="guimenu">System</span> → <span class="guimenuitem">Administration</span> → <span class="guimenuitem">Netværk</span></p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Tryk på <span class="guibutton"><strong>Lås op</strong></span> og skriv din adgangskode for at låse op for indstillingerne</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Vælg fanen <em class="guilabel">Forbindelser</em>.</p>
                      </li>
                      <li class="step" title="Trin 4">
                        <p>Vælg <em class="guilabel">Punkt-til-punkt-forbindelse</em> og tryk <span class="guibutton"><strong>Egenskaber</strong></span>.</p>
                      </li>
                      <li class="step" title="Trin 5">
                        <p>Markér <em class="guilabel">Aktivér denne forbindelse</em></p>
                      </li>
                      <li class="step" title="Trin 6">
                        <p>Vælg <em class="guilabel">Serielt modem</em> fra listen <em class="guilabel">Forbindelsestype</em>.</p>
                      </li>
                      <li class="step" title="Trin 7">
                        <p>Udfyld Telefonnummer og Forvalgsnummer under Data for internetudbyder.</p>
                      </li>
                      <li class="step" title="Trin 8">
                        <p>Udfyld Adgangskode og Brugernavn under Kontooplysninger.</p>
                      </li>
                      <li class="step" title="Trin 9">
                        <p>Klik på fanen <em class="guilabel">Modem</em>.</p>
                      </li>
                      <li class="step" title="Trin 10">
                        <p>Vælg de modemindstillinger, der er nødvendige for dig.</p>
                      </li>
                      <li class="step" title="Trin 11">
                        <p>Klik på <span class="guibutton"><strong>O.k.</strong></span>.</p>
                      </li>
                      <li class="step" title="Trin 12">
                        <p>Vælg fanen <em class="guilabel">DNS</em> og indtast DNS-adresserne for din internetudbyder.</p>
                      </li>
                      <li class="step" title="Trin 13">

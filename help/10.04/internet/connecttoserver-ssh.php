...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="prev" href="connecttoserver-ftp.php" title="FTP" />
    <link rel="next" href="connecttoserver-windowsshare.php" title="Windows-deling" />
  </head>
                ...
                <div class="sect1" title="SSH">
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      ...
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">SSH</em> fra <em class="guilabel">Tjenestetype</em>.</p>
                      </li>
                      <li class="listitem">
                      ...
                      <li class="listitem">
                        <p>Udfyld <em class="guilabel">Brugernanvn</em>.</p>
                      </li>
                      <li class="listitem">
                      ...
                      <li class="listitem">
                        <p>Du vil blive bedt om en adgangskode.</p>
                      </li>
                    </ol>
                  </div>
                </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Mobilt bredbånd</title>
    ...
    <link rel="prev" href="connecting-wireless.php" title="Trådløs" />
    <link rel="next" href="connecting-vpn.php" title="Virtuelle private netværk" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Mobilt bredbånd</h1>
              <div class="entry-content">
                <div class="sect1" title="Mobilt bredbånd">
                  <p>Ved <span class="emphasis"><em>Mobilt bredbånd</em></span> forstås enhver form for høJhastighedsforbindelse til internettet, som leveres af en ekstern enhed såsom en 3G USB-enhed eller en mobiltelefon med indbygget HSPA/UMTS/GPRS-dataforbindelse. Nogle bærbare computere er for nylig blevet produceret med mobile bredbåndsenheder indbygget fra starten.</p>
                  <p>De fleste Mobile bredbåndsenheder bør automatisk blive genkendt når du slutter dem til din computer. Ubuntu vil bede dig om at konfigurere enheden.</p>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Når du tilslutter enheden vil guiden <em class="guilabel">Ny mobil bredbåndsforbindelse</em> automatisk blive åbnet.</p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Klik på <span class="guibutton"><strong>Næste</strong></span> og indtast dine oplysninger, herunder det land hvor din mobile bredbåndsenhed blev udstedt, netværksudbyderen og forbindelsestypen (f.eks. <span class="emphasis"><em>Abonnement</em></span> eller <span class="emphasis"><em>Forudbetalt</em></span>).</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Giv din forbindelse et navn (det er op til dig hvad navn du vælger), og klik på <span class="guibutton"><strong>Anvend</strong></span>.</p>
                      </li>
                      <li class="step" title="Trin 4">
                        <p>Din forbindelse er nu klar til brug. Klik på ikonet for Netværkshåndteringen øverst til højre i panelet, og vælg din nye forbindelse for at forbinde.</p>
                      </li>
                      <li class="step" title="Trin 5">
                        <p>Venstreklik på ikonet for Netværkshåndteringen øverst til højre i panelet og klik på <span class="guibutton"><strong>Afbryd</strong></span> for at afbryde forbindelsen.</p>
                      </li>
                    </ol>
                  </div>
                  <p>Hvis du ikke bliver bedt om at konfigurere enheden når du tilslutter den, kan den stadig være blevet genkendt af Ubuntu. I sådanne tilfælde kan du tilføje forbindelsen manuelt.</p>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                      ...
                      <li class="step" title="Trin 2">
                        <p>Vælg fanen <em class="guilabel">Mobilt bredbånd</em>.</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Klik på <span class="guibutton"><strong>Tilføj</strong></span>.</p>
                      </li>
                      <li class="step" title="Trin 4">
                        <p>Dette vil åbne guiden <em class="guilabel">Ny mobil bredbåndsforbindelse</em>. Indtast dine oplysninger som beskrevet ovenfor.</p>
                      </li>
                    </ol>
                  </div>
                </div>

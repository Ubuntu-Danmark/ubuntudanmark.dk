...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 5. Fejlfinding</title>
    ...
    <link rel="prev" href="information.php" title="Kapitel 4. Information om din forbindelse" />
    <link rel="next" href="troubleshooting-lan.php" title="Fejlfinding for kablet netopkobling" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 5. Fejlfinding</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 5. Fejlfinding">
                  <p>Siden indførelsen af Netværkshåndtering, kan forbindelser aktiveres og deaktiveres fra ikonet for Netværkshåndtering i <em class="guilabel">statusfeltet</em>.</p>
                    ...
                    <table border="0" summary="Important">
                      ...
                      <tr>
                        <td align="left" valign="top">
                          <p>Du bedes kontrollere om netopkoblingen er aktiv, inden forsøg på fejlsøgning:</p>
                          <div class="orderedlist">
                            <ol class="orderedlist" type="1">
                              <li class="listitem">
                                <p>Højreklik på ikonet for Netværkshåndtering i statusfeltet.</p>
                              </li>
                              <li class="listitem">
                                <p>Afkryds <em class="guilabel">Aktivér netopkobling</em>.</p>
                              </li>
                              <li class="listitem">
                                <p>Afkryds <em class="guilabel">Aktivér trådløs opkobling</em>.</p>
                              </li>
                            </ol>
                          </div>
                        </td>

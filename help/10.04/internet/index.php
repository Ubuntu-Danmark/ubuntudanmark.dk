...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Internet og netværk</title>
    ...
    <link rel="next" href="networkmanager.php" title="Kapitel 1. Opret forbindelse til internettet eller et netværk" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Internet og netværk</h1>
              <div class="entry-content">
                <div xml:lang="da" class="book" title="Internet og netværk" lang="da">
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Fejlfinding for mobil bredbånd</title>
    ...
    <link rel="prev" href="troubleshooting-wireless.php" title="Fejlfinding af trådløs netopkobling" />
    <link rel="next" href="troubleshooting-keyring.php" title="Hvorfor spørger Gnome Nøglering om min adgangskode hver gang jeg logger ind?" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Fejlfinding for mobil bredbånd</h1>
              <div class="entry-content">
                <div class="sect1" title="Fejlfinding for mobil bredbånd">
                  <p>Nogle USB-enheder til mobilt bredbånd bliver ikke identificeret korrekt i Ubuntu. Dette er på grund af en funktion, der tillader dem at optræde som USB-lagerenheder for at installere drivere i Windows og Mac OS. Prøv at afmontere eller skubbe enheden ud ved at højreklikke på ikonet på skrivebordet og vælge <em class="guilabel">Afmontér</em> eller <em class="guilabel">Skub ud</em>.</p>
                  <p>Hvis din enhed stadig ikke blev genkendt, kan du indsende en fejlrapport for pakke <span class="application"><strong>udev</strong></span>, ved at skrive følgende kommando i terminalen:</p>
                  <pre class="screen">
                    <span class="command">
                      <strong>ubuntu-bug udev</strong>
                    </span>
                  </pre>
                </div>
              </div>

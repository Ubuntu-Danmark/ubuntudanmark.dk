...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Se andre computere på netværket</title>
    ...
    <link rel="prev" href="networking.php" title="Kapitel 8. Hjemmenetværk" />
    <link rel="next" href="networking-shares.php" title="Del filer og mapper med andre computere" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Se andre computere på netværket</h1>
              <div class="entry-content">
                <div class="sect1" title="Se andre computere på netværket">
                  <p>Åbn <span class="guimenu">Steder</span> → <span class="guimenuitem">Netværk</span> for at se computerne på netværket.</p>
                  <p>Du skal muligvis indtaste et brugernavn, adgangskode og domæne. Du bør kunne få disse fra din netværksadministrator, hvis nødvendigt. Brugernavn og adgangskode vil normalt være brugernavn og adgangskode for en bruger på den computer, du forsøger at forbinde til.</p>
                  <p>Det er ofte ikke nødvendigt at udfylde domænet.</p>
                  <p>Se <a class="ulink" href="http://library.gnome.org/users/user-guide/2.30/nautilus-accessnetwork.html" target="_top">Navigering af fjernservere</a> for yderligere information.</p>
                </div>
              </div>
            </div>
          </div>

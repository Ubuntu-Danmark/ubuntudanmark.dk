...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 9. Internetprogrammer</title>
    ...
    <link rel="prev" href="networking-shares.php" title="Del filer og mapper med andre computere" />
    <link rel="next" href="web-browsing.php" title="På nettet med Firefox" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 9. Internetprogrammer</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 9. Internetprogrammer">
                  <p>Dette afsnit giver oplysninger om brugen af gængse internetprogrammer, såsom internetbrowsere og e-post-klienter.</p>
                </div>
              </div>
            </div>
          </div>

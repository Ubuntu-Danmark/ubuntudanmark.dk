...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Identificer dit modem</title>
    ...
    <link rel="prev" href="modem.php" title="Kapitel 6. Modemmer" />
    <link rel="next" href="modem-connect.php" title="Opkobling med et modem" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Identificer dit modem</h1>
              <div class="entry-content">
                <div class="sect1" title="Identificer dit modem">
                  <p>De fleste opkaldsmodemmer understøttes ikke af Ubuntu, men der kan findes drivere, som vil gøre det muligt at anvende nogle af disse modemer. Først skal du identificere hvilkent chipsæt dit opkaldsmodem har:</p>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Hent <span class="application"><strong>scanmodem</strong></span> (<a class="ulink" href="http://linmodems.technion.ac.il/packages/scanModem.gz" target="_top">http://linmodems.technion.ac.il/packages/scanModem.gz</a>) fra en computer med en internetforbindelse.</p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Kopier den hentede fil til Hjemmemappe på computeren med det opkaldsmodem du ønsker at bruge.</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Åbn en Terminal (<span class="guimenu">Programmer</span> → <span class="guimenuitem">Tilbehør</span> → <span class="guimenuitem">Terminal</span>) og skrive følgende kommandoer, idet du trykker <span class="keycap"><strong>Enter</strong></span> efter hver linje:</p>
                        <pre class="screen">
...
gedit Modem/ModemData.txt
                      ...
                      <li class="step" title="Trin 4">
                        <p>En fil, der indeholder oplysninger om de chipsæt der anvendes af eventuelle fundene modemmer, bør blive åbnet. Udskriv eller gem oplysningerne.</p>
                      </li>
                    </ol>
                  </div>
                  <p>Langt mere detaljerede oplysninger kan indes <a class="ulink" href="https://help.ubuntu.com/community/DialupModemHowto" target="_top">på fællesskabets wiki</a>.</p>
                </div>
              </div>
            </div>
          </div>

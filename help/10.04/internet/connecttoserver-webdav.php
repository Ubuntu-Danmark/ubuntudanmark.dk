...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="prev" href="connecttoserver-windowsshare.php" title="Windows-deling" />
    <link rel="next" href="connecttoserver-custom.php" title="Tilpasset" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">WebDAV (HTTP)</h1>
              <div class="entry-content">
                <div class="sect1" title="WebDAV (HTTP)">
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      ...
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">WebDAV (HTTP)</em> fra <em class="guilabel">Tjenestetype</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Indtast serverens adressen i <em class="guilabel">Server</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Indtast <em class="guilabel">Port</em>, <em class="guilabel">Mappe</em> og <em class="guilabel">Brugernavn</em> hvis nødvendigt. Dette er valgfrit.</p>
                      </li>
                      <li class="listitem">

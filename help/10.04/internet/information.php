...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 4. Information om din forbindelse</title>
    ...
    <link rel="prev" href="disconnecting.php" title="Kapitel 3. Frakobling" />
    <link rel="next" href="troubleshooting.php" title="Kapitel 5. Fejlfinding" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 4. Information om din forbindelse</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 4. Information om din forbindelse">
                  <p>Højreklik på ikonet for Netværkshåndteringen og klik på <em class="guilabel">Forbindelsesinformation</em> for at se detaljerne for din forbindelse. Her finder du din IP-adresse, DNS-server, MAC-adresse samt hastigheden på din forbindelse.</p>
                </div>
              </div>
            </div>
          </div>

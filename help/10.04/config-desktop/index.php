...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Tilpas din computer</title>
    ...
    <link rel="next" href="window-button-order.php" title="Hvordan kan jeg flytte vinduets knapper til det øverste højre hjørne?" />
  </head>
      ...
      <div id="header">
        ...
        <div id="access">
          <div id="loco-header-menu">
            ...
            $primary_header_menu = str_replace(' menu-item-637', ' menu-item-636 current-menu-item', $primary_header_menu);
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Tilpas din computer</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Tilpas din computer" lang="da">
                  <p>Dette afsnit beskriver hvordan du kan ændre udseendet og oplevelsen af din computer.</p>
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      <li class="listitem">
                        <p>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.30/panels.html" target="_top">Tilpasning af paneler</a>
		</p>
                      </li>
                      <li class="listitem">
                        <p>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.30/menubar.html" target="_top">Hovedmenuen</a>
		</p>
                      </li>
                      <li class="listitem">
                        <p>
			<a class="ulink" href="../desktop-effects/" target="_top">Visuelle effekter</a>
		</p>
                      </li>
                      <li class="listitem">
                        <p>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.30/prefs.html" target="_top">Tilpasning af andre aspekter af skrivebordet</a>
		</p>
                      </li>
                    </ol>
                  </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Afspilning af dvd'er</title>
    ...
    <link rel="prev" href="video.php" title="Kapitel 2. Film, dvd'er og videoer" />
    <link rel="next" href="video-playback.php" title="Hvordan kan jeg afspille mine videoer?" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Afspilning af dvd'er</h1>
              <div class="entry-content">
                <div class="sect1" title="Afspilning af dvd'er">
                  <p>For at kunne afspille dvd'er skal du først installere yderligere software. Desværre kan dvd-understøttelse ikke være standard i Ubuntu på grund af lovlige restriktioner i nogle lande.</p>
                    ...
                    <table border="0" summary="Warning">
                      ...
                      <tr>
                        <td align="left" valign="top">
                          <p>Læs om <a class="ulink" href="../add-applications/restricted-software.php" target="_top"> begrænsede formater</a> før du følger instruktionerne nedenfor. Der er nogle juridiske overvejelser, du bør kende til.</p>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Installer pakkerne <a class="ulink" href="apt:libdvdnav4" target="_top">libdvdnav4</a>, <a class="ulink" href="apt:libdvdread4" target="_top">libdvdread4</a>, <a class="ulink" href="apt:gstreamer0.10-plugins-bad" target="_top">gstreamer0.10-plugins-bad</a> og <a class="ulink" href="apt:gstreamer0.10-plugins-ugly" target="_top">gstreamer0.10-plugins-ugly</a>.</p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Hvis du ønsker at afspille krypterede dvd'er, tast <span class="guimenu">Programmer</span> → <span class="guimenuitem">Tilbehør</span> → <span class="guimenuitem">Terminal</span> og tast det følgende ind i skærmen som kommer frem, efterfulgt af <span class="keycap"><strong>Retur</strong></span>: </p>
                        <pre class="screen">sudo /usr/share/doc/libdvdread4/install-css.sh</pre>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Indtast din adgangskode hvis der bliver bedt om den. Pakken <span class="application"><strong>libdvdcss2</strong></span> vil blive hentet og installeret fra en internetside.</p>
                      </li>
                      <li class="step" title="Trin 4">
                        <p>Indsæt en dvd i dit drev. Den bør automatisk åbne i Filmafspiller.</p>
                      </li>
                    </ol>
                  </div>
                </div>

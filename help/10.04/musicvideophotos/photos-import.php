...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Importér fotos fra digitalkamera, harddisk eller hukommelseskort</title>
    ...
    <link rel="prev" href="photos.php" title="Kapitel 3. Billeder og kameraer" />
    <link rel="next" href="photos-organize.php" title="Organiser din billedsamling" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Importér fotos fra digitalkamera, harddisk eller hukommelseskort</h1>
              <div class="entry-content">
                <div class="sect1" title="Importér fotos fra digitalkamera, harddisk eller hukommelseskort">
                  <p>Ubuntu opdager automatisk de fleste digitale kameraer, når du tilslutter dem, og vil automatisk tilbyde dig at kopiere dine billeder ind.</p>
                  <p>For at importere billeder fra dit kamera:</p>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Tilslut kameraet og tænd det ved at sætte det i visningstilstand. Ubuntu bør spørge dig, om du vil importere de billeder, der ligger på kameraet.</p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Klik på <span class="guibutton"><strong>Importer</strong></span>. Du skulle nu se en forhåndsvisning af billederne.</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Vælg en placering hvor du vil gemme dine billeder, og klik derefter på <span class="guibutton"><strong>Importer</strong></span>. Billederne vil derefter blive gemt på din harddisk.</p>
                      </li>
                    </ol>
                  </div>
                  <p>Hvis Ubuntu ikke spørger dig om billederne skal importeres:</p>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Åbn <span class="guimenu">Programmer</span> → <span class="guimenuitem">Grafik</span> → <span class="guimenuitem">F-Spot fotohåndtering</span>. Hvis det er første gang, du bruger <span class="application"><strong>F-Spot</strong></span>, vil Importér vinduet åbne automatisk. Ellers skal du vælge <span class="guimenu">Foto</span> → <span class="guimenuitem">Importér...</span>.</p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Vælg dit digitale kamera, harddisk eller hukommelseskort, som <em class="guilabel">Importkilde</em> og klik derefter på <span class="guibutton"><strong>Åbn</strong></span>. Du vil nu se forhåndsvisning af dine fotos.</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Klik <span class="guibutton"><strong>Importér</strong></span> for at begynde med at importere dine fotos. Som standard bliver dine fotos gemt i mappen Billeder i din <span class="guimenu">Steder</span> → <span class="guimenuitem">Hjemmemappe</span>.</p>
                      </li>
                    </ol>
                  </div>
                  <p>Hvis dit kamera ikke står opført som en importkilde, skal du trykke <span class="guimenu">Steder</span> → <span class="guimenuitem">Maskine</span> og se om dit kamera er synligt der, som en flytbar lagringsenhed.</p>
                </div>
              </div>
            </div>
          </div>

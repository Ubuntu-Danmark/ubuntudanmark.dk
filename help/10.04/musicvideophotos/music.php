...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 1. Musik</title>
    ...
    <link rel="prev" href="index.php" title="Musik, video og fotos" />
    <link rel="next" href="music-listen.php" title="Lyt" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 1. Musik</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 1. Musik">
                  <p>Dette afsnit beskriver hvordan der kan importeres, organiseres og bruges musik, videoer og billeder med Ubuntu.</p>
                </div>
              </div>
            </div>
          </div>

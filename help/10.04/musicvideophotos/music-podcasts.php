...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Podcasts og internetradio-stationer</title>
    ...
    <link rel="prev" href="music-convert.php" title="Konvertering af musikfiler" />
    <link rel="next" href="music-download.php" title="Hent musik på internettet" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Podcasts og internetradio-stationer</h1>
              <div class="entry-content">
                <div class="sect1" title="Podcasts og internetradio-stationer">
                  <p><span class="strong"><strong>Podcasts</strong></span> er optagede udsendelser, som du kan hente og lytte til på din computer eller mobile lydafspiller. Tusinder af podcasts er tilgængelige, og de fleste kan frit hentes.</p>
                  <p>Du kan bruge Rhythmbox til at hente og afspille podcasts; vælg <em class="guilabel">Podcasts</em> i afsnittet <em class="guilabel">Bibliotek</em> i Rhythmboxvinduet for at komme i gang. <a class="ulink" href="http://library.gnome.org/users/rhythmbox/unstable/" target="_top">Rhythmbox musikafspiller manual</a> har yderligere informationer. Alternativt foretrækker du måske et decideret podcasthåndteringsprogram som <a class="ulink" href="apt:gpodder" target="_top">gPodder</a> eller <a class="ulink" href="apt:penguintv" target="_top">PenguinTV</a>.</p>
                  <p><span class="strong"><strong>Internetradiostationer</strong></span> er direkte <span class="emphasis"><em>lyd-stream</em></span>, ligesom almindelig radio, men overført via internettet. Du kan lytte til radiostationer på internettet ved hjælp af Rhythmbox eller Banshee, streams virker også i nogle andre musikafspillere. Vælg <em class="guilabel">Radio</em> fra venstre side i Rhythmbox- eller Banshee-vinduet for at lytte til internetradio. Vælg der efter enten en station fra listen eller indtaste webadressen på den station, du ønsker at lytte til. For mere information kan du kigge i <a class="ulink" href="http://library.gnome.org/users/rhythmbox/unstable/" target="_top">Rhythmbox manualen</a>.</p>
                  <p><span class="strong"><strong>RealAudio strømme</strong></span>, som bruges af nogle internet radiostationer, er ikke understøttet af Rhythmbox. For at høre på denne type af strøm skal du <a class="link" href="video-realplayer.php" title="Installering og opsætning af RealPlayer">installere RealPlayer</a>.</p>
                </div>
              </div>
            </div>
          </div>

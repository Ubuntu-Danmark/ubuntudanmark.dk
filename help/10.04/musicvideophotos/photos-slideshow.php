                ...
                <div class="sect1" title="Se et diasshow af dine billeder">
                  ...
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>Se et diasshow ved brug af <a class="ulink" href="http://library.gnome.org/users/eog/2.30/eog-view.html#eog-fullscreen" target="_top"> gThump - billedfremviseren</a></p>
                      </li>
                      <li class="listitem">

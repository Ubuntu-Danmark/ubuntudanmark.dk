...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 3. Billeder og kameraer</title>
    ...
    <link rel="prev" href="video-editing.php" title="Optagelse og redigering af video" />
    <link rel="next" href="photos-import.php" title="Importér fotos fra digitalkamera, harddisk eller hukommelseskort" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 3. Billeder og kameraer</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 3. Billeder og kameraer">
                  <p>Der er mange værktøjer tilgængelige, som kan hjælpe dig med at arbejde på din digitale billedsamling.</p>
                </div>
              </div>
            </div>
          </div>

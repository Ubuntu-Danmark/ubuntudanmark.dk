...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 4. Brænde cd'er og dvd'er</title>
    ...
    <link rel="prev" href="photos-editing.php" title="Rediger og forbedr billeder" />
    <link rel="next" href="troubleshooting.php" title="Kapitel 5. Løsninger på almindelige problemer" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 4. Brænde cd'er og dvd'er</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 4. Brænde cd'er og dvd'er">
                  <p>Du kan oprette dine egne cd'er ved at <span class="emphasis"><em>brænde</em></span> filer på en tom disk ved brug af dit <span class="emphasis"><em>cd-brænderdrev</em></span>.</p>
                  <p>Brug Brasero diskbrænding software til at skabe data, lyd-og video-cd'er, kopierer cd'er og dvd'er og oprette cd'er fra diskaftryksfiler. Klik <span class="guimenu">Programmer</span> → <span class="guimenuitem">Lyd &amp; Video</span> → <span class="guimenuitem">Brasero diskbrænder</span> for at starte Brasero.</p>
                  <p>For hjælp og vejledning, læs <a class="ulink" href="http://library.gnome.org/users/brasero/2.30/" target="_top">Brasero manualen</a>.</p>
                </div>
              </div>
            </div>
          </div>

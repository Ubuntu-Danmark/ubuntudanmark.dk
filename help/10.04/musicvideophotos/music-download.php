...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Hent musik på internettet</title>
            ...
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              ...
              <div class="entry-content">
                <div class="sect1" title="Hent musik på internettet">
                  ...
                  <p>To tjenester der tilbyder ubegrænset (DRM-fri) musik er <a class="ulink" href="http://www.jamendo.com" target="_top">Jamendo</a> og <a class="ulink" href="http://www.magnatune.com/" target="_top">Magnatune</a>. Du kan købe sange fra begge disse butikker på nettet eller direkte fra Rhythmbox, hvis de relevante moduler er aktiveret (læs <a class="ulink" href="http://library.gnome.org/users/rhythmbox/unstable/" target="_top">Rhythmbox manualen</a> for mere information).</p>
                    ...
                    <table border="0" summary="Caution">
                      ...
                      <tr>
                        <td align="left" valign="top">
                          <p>At hente musik fra internettet uden tilladelse fra ophavsrettighedshaverne anses for ulovligt i mange lande. Du bør derfor undersøge, at du har rettigheder til at hente en musikfil, før du gemmer den på din computer.</p>
                        </td>
                      </tr>
                    </table>
                  </div>

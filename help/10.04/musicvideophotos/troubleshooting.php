...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 5. Løsninger på almindelige problemer</title>
    ...
    <link rel="prev" href="cdburning.php" title="Kapitel 4. Brænde cd'er og dvd'er" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 5. Løsninger på almindelige problemer</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 5. Løsninger på almindelige problemer">
                  <p>Dette afsnit tilbyder løsninger på almindelige problemer.</p>
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      <li class="listitem">
                        <p>Sørg for at cd'er ikke afspilles, når de indsættes, se <a class="xref" href="music-listen.php#music-cd-autoplay" title="Hvordan kan jeg forhindre cd'er fra at blive afspillet, når jeg indsætter dem?">“Hvordan kan jeg forhindre cd'er fra at blive afspillet, når jeg indsætter dem?”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Sangnavne og albumgrafik passer ikke, se <a class="xref" href="music-listen.php#music-missingmetadata" title="Sangnavne/omslag mangler/er forkerte for nogle sange">“Sangnavne/omslag mangler/er forkerte for nogle sange”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Rhythmbox kan ikke rippe MP3-filer, se <a class="xref" href="music-convert.php" title="Konvertering af musikfiler">“Konvertering af musikfiler”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Min MP3-afspiller virker i Windows men ikke i Ubuntu, se <a class="xref" href="music-portable.php#music-portable-mtp" title="MTP-medieafspillere">“MTP-medieafspillere”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Jeg kan ikke afspille videoer, se <a class="xref" href="video-dvd.php" title="Afspilning af dvd'er">“Afspilning af dvd'er”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Jeg kan ikke afspille QuickTime eller WMV, se <a class="xref" href="video-playback.php#video-playback-file" title="Videofiler">“Videofiler”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Jeg kan ikke afspille flash-video, se <a class="xref" href="video-playback.php#video-playback-flash" title="Flashvideoer">“Flashvideoer”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Jeg kan ikke afspille Realmedia, se <a class="xref" href="video-realplayer.php" title="Installering og opsætning af RealPlayer">“Installering og opsætning af RealPlayer”</a></p>
                      </li>
                      <li class="listitem">
                        <p>Min mikrofon virker ikke, se <a class="xref" href="music-microphone.php" title="Min mikrofon virker ikke eller er for lav">“Min mikrofon virker ikke eller er for lav”</a></p>
                      </li>
                    </ol>
                  </div>
                </div>

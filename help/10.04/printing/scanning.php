                ...
                <div class="section" title="Brug af skanner">
                  ...
                  <div class="section" title="Virker min skanner med Ubuntu?">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="id607040"></a>Virker min skanner med Ubuntu?</h3>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="section" title="Brug af din skanner">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="id607095"></a>Brug af din skanner</h3>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="section" title="Hvad hvis den siger &quot;Ingen tilgængelige enheder&quot;?">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="id607152"></a>Hvad hvis den siger "Ingen tilgængelige enheder"?</h3>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="section" title="Manuel installation af skanner">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="id607210"></a>Manuel installation af skanner</h3>
                        </div>
                      </div>
                    </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Tilføj, fjern og opdatér programmer</title>
    ...
    <link rel="next" href="installation-windows-ubuntu.php" title="Hvordan er softwareinstallation på Ubuntu anderledes end på Windows?" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Tilføj, fjern og opdatér programmer</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Tilføj, fjern og opdatér programmer" lang="da">
                  <p>Dette afsnit omfatter, hvordan programmer installeres, fjernes og holdes ajour. Yderligere omfatter det hvordan pakker er lagret af Ubuntu og gjort tilgængelige, så de kan hentes.</p>
                </div>
              </div>
            </div>
          </div>

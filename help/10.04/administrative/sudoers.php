                  ...
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      ...
                      <li class="step" title="Trin 2">
                        <p>Klik <span class="guibutton"><strong>Lås op</strong></span> og indtast din kode</p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Vælg den bruger som skal gives administrativ adgang og klik på <span class="guibutton"><strong>Egenskaber</strong></span></p>
                      </li>

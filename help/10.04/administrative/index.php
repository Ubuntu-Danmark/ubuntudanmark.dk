...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Administrative opgaver</title>
    ...
    <link rel="next" href="sudoers.php" title="Tildel en bruger administrativ adgang" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Administrative opgaver</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Administrative opgaver" lang="da">
                  <p>Af sikkerhedsmæssige grunde, kan administrative opgaver i Ubuntu kun udføres af brugere med særlige administrative privilegier. Den første brugerkonto der blev oprettet under installationen, vil som standard være i stand til at udføre administrative opgaver.</p>
                  <p>Når du kører programmer som behøver administrative rettigheder bliver du bedt om at indtaste din kode. Dette beskytter dit system mod ondsindede filer og mod tilfældigvis at vælge opsætninger, som ændrer dit system.</p>
                  <p>Hver gang du indtaster dit kodeord husker systemet det i 15 minutter, så du ikke skal indtaste det igen.</p>
                </div>
              </div>
            </div>
          </div>

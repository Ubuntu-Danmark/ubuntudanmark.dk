...
<body class="page page-template page-template-default">
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Hjælp til Ubuntu</h1>
              <div class="entry-content">
                <p>Under denne sektion finder du hjælpe filerne til de forskellige udgaver af Ubuntu, vælg din udgave og dyk ned i informationen.</p>
					</div><!-- .entry-content -->
				</div><!-- #post -->
			</div><!-- #content -->
		</div><!-- #container -->

        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Søg i hjælp for Ubuntu 10.10</h1>
              <div class="entry-content">
                <div id="cse" style="width: 100%;">Loading</div>
                <script async="true" src="http://www.google.com/jsapi" type="text/javascript"></script>
                <script async="true" type="text/javascript">
                  google.load('search', '1', {language : 'da'});
                  google.setOnLoadCallback(function() {
                    var customSearchControl = new google.search.CustomSearchControl('004765682010989556722:tzdwjz5hfgk');
                    customSearchControl.setResultSetSize(google.search.Search.FILTERED_CSE_RESULTSET);
                    customSearchControl.draw('cse');
                    document.getElementsByClassName("gsc-search-box")[0].style.display = 'none';
                    document.getElementsByClassName("gsc-input")[1].value = '<?php echo addcslashes($_GET['s'], "\\'"); ?>';
        ...
        <div class="aside main-aside" id="secondary" style="-moz-border-radius: 5px 5px 5px 5px;">
          <ul class="xoxo">
            <li class="widgetcontainer widget" id="">
              ...
              <ul>
                <li><a href="/help/10.10/about-ubuntu/">Om Ubuntu</a></li>
                <li><a href="/help/10.10/newtoubuntu/">Ny bruger af Ubuntu?</a></li>
                <li><a href="/help/10.10/add-applications/">Tilføj, fjern og opdatér programmer</a></li>
                <li><a href="/help/10.10/musicvideophotos/">Musik, video og fotos</a></li>
                <li><a href="/help/10.10/office/">Kontor</a></li>
                <li><a href="/help/10.10/printing/">Udskrivning, fax og skanning</a></li>
                <li><a href="/help/10.10/internet/networkmanager.php">Internet og netværk</a></li>
                <li><a href="/help/10.10/keeping-safe/">Hold din computer sikker</a></li>
                <li><a href="/help/10.10/hardware/">Arbejde med hardware-enheder</a></li>
                <li><a href="/help/10.10/config-desktop/">Tilpas din computer</a></li>
                <li><a href="/help/10.10/desktop-effects/">Visuelle effekter</a></li>
                <li><a href="/help/10.10/administrative/">Administrative opgaver</a></li>
                <li><a href="/help/10.10/files-and-docs/">Filer, mapper og dokumenter</a></li>
                <li><a href="/help/10.10/games/">Spil</a></li>
                <li><a href="/help/10.10/usb-creator/">Opret en USB-opstartsdisk</a></li>
              </ul>
            </li>
          </ul>
        </div>

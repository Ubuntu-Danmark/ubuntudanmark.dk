          ...
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              ...
              <div class="entry-content">
                <div class="chapter" title="Kapitel 3. At bruge et program når det er installeret">
                  <p>For de fleste programmer, når først de er installeret, kan du starte dem fra menuen <span class="guimenu">Programmer</span>. (Værktøjer for at ændre indstillinger er mulighvis under <span class="guimenu">System</span> → <span class="guisubmenu">Indstillinger</span> eller <span class="guimenu">System</span> → <span class="guisubmenu">Administration</span> i stedet for).</p>
                  <p>For at se hvor du kan starte et nyt program, kan du gå til skærmen for det program i Softwarecenteret, hvis ikke den stadig er vist. Menuplaceringen vises på skærmen under den farvede linje.</p>
                  <p>Hvis du bruger Ubuntu Netbook Edition, optræder et program under den gældende kategori på startskærmen.</p>

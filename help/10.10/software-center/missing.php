...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 10. Hvad hvis et program jeg ønsker ikke er tilgængeligt?</title>
    ...
    <link rel="prev" href="commercial-reinstalling.php" title="Kapitel 9. Hvad hvis jeg betaler for software og mister det?" />
    <link rel="next" href="bugs.php" title="Kapitel 11. Hvad hvis et program ikke virker?" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 10. Hvad hvis et program jeg ønsker ikke er tilgængeligt?</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 10. Hvad hvis et program jeg ønsker ikke er tilgængeligt?">
                  <p>Kontroller først at <span class="guimenu">Vis</span> → <span class="guimenuitem">Alt software</span> er valgt.</p>
                  <p>Hvis den software du ønsker stadig ikke er der, men du ved at den kan køre på Ubuntu, så prøv at kontakte de oprindelige udviklere af programmet, og spørg om de kan hjælpe med at gøre programmet tilgængelig.</p>
                  <p>Hvis et program er tilgængeligt for andre styresystemer end Ubuntu, så gør udviklerne opmærksom på at du er interesseret i at køre det på Ubuntu.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 4. At fjerne software</title>
    ...
    <link rel="prev" href="launching.php" title="Kapitel 3. At bruge et program når det er installeret" />
    <link rel="next" href="metapackages.php" title="Kapitel 5. Hvorfor beder den mig om at fjerne flere programmer på en gang?" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 4. At fjerne software</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 4. At fjerne software">
                  <p>For at fjerne software, skal du have administratoradgang. (Hvis du selv har installeret Ubuntu på denne computer, har du automatisk administratorrettigheder).</p>
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      <li class="listitem">
                        <p>Find det du ønsker at fjerne, i sektionen<em class="guilabel">Installeret software</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Vælge emnet på listen, og tryk på <em class="guilabel">Fjern</em>. Det kan være nødvendigt at du indtaster din Ubuntu adgangskode.</p>
                      </li>
                    </ol>
                  </div>
                  <p>Hvis et program er åbent når du fjerner det, vil det normalt forblive åbent selv efter det er fjernet. Så snart du lukker det, vil det ikke længere være tilgængelige.</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>
                          <a class="xref" href="metapackages.php" title="Kapitel 5. Hvorfor beder den mig om at fjerne flere programmer på en gang?">Hvorfor beder den mig om at fjerne flere programmer på en gang?</a>
                        </p>
                      </li>
                    </ul>
                  </div>

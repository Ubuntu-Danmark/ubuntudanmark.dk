...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 8. Skal jeg betale noget?</title>
    ...
    <link rel="prev" href="canonical-partners.php" title="Kapitel 7. Hvad er “Canonical Partners”?" />
    <link rel="next" href="commercial-reinstalling.php" title="Kapitel 9. Hvad hvis jeg betaler for software og mister det?" />
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 8. Skal jeg betale noget?</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 8. Skal jeg betale noget?">
                  <p>Det meste software i Ubuntu Softwarecenteret er gratis.</p>
                  <p>Hvis noget koster penge, har det en <em class="guilabel">Køb</em> knap i stedet for en <em class="guilabel">Installér</em> knap, og dens pris vises på skærmen for hvert program.</p>
                  <p>For at betale for kommercielt software, skal du have en internet forbindelse, og en Ubuntu Single SIgn On konto eller en konto på Launchpad. Hvis ikke du har en konto, vil Ubuntu Softwarecenteret hjælpe dig med at oprette en.</p>
                </div>
              </div>
            </div>
          </div>

        ...
        <div id="container">
          <div id="content">
                ...
                <div xml:lang="da" class="article" title="Tilpas din computer" lang="da">
                  ...
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      <li class="listitem">
                        <p>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.32/panels.html" target="_top">Tilpasning af paneler</a>
		</p>
                      </li>
                      <li class="listitem">
                        <p>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.32/menubar.html" target="_top">Hovedmenuen</a>
		</p>
                      </li>
                      <li class="listitem">
                        <p>
			<a class="ulink" href="../desktop-effects/" target="_top">Visuelle effekter</a>
                      ...
                      <li class="listitem">
                        <p>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.32/prefs.html" target="_top">Tilpas andre aspekter af skrivebordet</a>
		</p>
                      </li>
                    </ol>
                  </div>

            ...
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              ...
              <div class="entry-content">
                <div class="sect1" title="Brug af KDE eller Xfce i stedet for GNOME-skrivebordet">
                  ...
                  <p>Dette emne indeholder instruktioner i hvordan du installerer og bruger en andet skrivebord end standarden GNOME, f.eks. KDE eller Xfce.</p>
                  <div class="sect2" title="Installér et KDE-skrivebord">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="other-desktop-kde"></a>Installér et KDE-skrivebord</h3>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="sect2" title="Installér et Xfce-skrivebord">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="other-desktop-xfce"></a>Installér et Xfce-skrivebord</h3>
                        </div>
                      </div>
                    </div>

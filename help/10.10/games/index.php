...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="next" href="games-ubuntu-popular.php" title="Populære spil" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Spil</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Spil" lang="da">
                  <p>Du kan finde Ubuntus spil ved at klikke <span class="guimenu">Programmer</span> → <span class="guimenuitem">Spil</span>.</p>
                  <p>Ubuntu indeholder som standard 16 spil, deriblandt <span class="application"><strong>Kabale</strong></span> (eller <span class="application"><strong>AisleRiot</strong></span>), <span class="application"><strong>Gnometris</strong></span> og <span class="application"><strong>Minestryger</strong></span> (<span class="application"><strong>Mines</strong></span>). Der findes mange flere spil, som du valgfrit selv kan installere. Det er meningen at dette afsnit kan give dig en opsummering af nogle af de spil, som du kan installere og spille.</p>
                </div>
              </div>
            </div>
          </div>

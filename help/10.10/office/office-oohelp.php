...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Få hjælp til OpenOffice</title>
    ...
    <link rel="prev" href="office-suites.php" title="Kontorpakker" />
    <link rel="next" href="office-dtp.php" title="DTP og tegneprogrammer" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Få hjælp til OpenOffice</h1>
              <div class="entry-content">
                <div class="sect1" title="Få hjælp til OpenOffice">
                  <p>Der er mange muligheder for at få hjælp med OpenOffice til rådighed.</p>
                    ...
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>
                          <span class="strong">
                            <strong>
                              <a class="ulink" href="http://documentation.openoffice.org/" target="_top">Officiel dokumentationshjemmeside</a>
                            </strong>
                          </span>
                        </p>
                        <p>En meget omfattende hjemmeside, som indeholder manualer, praktiske vejledninger, ofte stillede spørgsmål og eksempler på dokumenter.</p>
                      </li>
                      <li class="listitem">
                        <p>
                          <span class="strong">
                            <strong>
                              <a class="ulink" href="http://wiki.services.openoffice.org/wiki/Documentation/FAQ/Overview" target="_top">Ofte stillede spørgsmål</a>
                            </strong>
                          </span>
                        </p>
                        <p>En samling af de oftest stillede spørgsmål om brug af OpenOffice.org.</p>
                      </li>
                    </ul>
                  </div>
                </div>

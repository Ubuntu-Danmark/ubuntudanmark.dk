            ...
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              ...
              <div class="entry-content">
                <div class="sect1" title="Tildel en separat brugerkonto til hver person">
                  ...
                  <p>Se <a class="ulink" href="http://library.gnome.org/users/users-admin/2.32/" target="_top">manualen til Brugerindstillinger</a> for yderligere oplysninger om oprettelse af brugerkonti.</p>
                </div>
              </div>
            </div>
          </div>

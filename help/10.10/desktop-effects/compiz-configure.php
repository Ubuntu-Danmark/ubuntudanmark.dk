...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Konfigurering af visuelle effekter</title>
    ...
    <link rel="prev" href="compiz-intro.php" title="Hvad er visuelle effekter?" />
    <link rel="next" href="compiz-default-plugins.php" title="Brug af tastaturgenveje med visuelle effekter" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Konfigurering af visuelle effekter</h1>
              <div class="entry-content">
                <div class="sect1" title="Konfigurering af visuelle effekter">
                  <p>Vælg <span class="guimenu">System</span> → <span class="guimenuitem">Indstillinger</span> → <span class="guimenuitem">Udseende</span> → <span class="guimenuitem">Visuelle effekter</span> for at vælge grundlæggende indstillinger for visuelle effekter.</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">ingen</em> for et simpelt skrivebord uden effekter.</p>
                      </li>
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">Normal</em> for at give en god balance mellem attraktivitet og ydeevne.</p>
                      </li>
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">Ekstra</em> for at aktivere et æstetisk tiltalende sæt af grafiske effekter.</p>
                      </li>
                    </ul>
                  </div>
                  <p>Når du vælger en indstilling, kan det tage adskillige sekunder før ændringen træder i kraft. I den tid vil din skærm muligvis blinke kortvarigt.</p>
                  <p>Når indstillingerne er trådt i kraft, vil der dukke en dialogboks op, som spørger, om du vil beholde de nye indstillinger eller vende tilbage til de forrige. Klik på <span class="guibutton"><strong>Behold indstillinger</strong></span>, hvis du vurderer, at de nye indstillinger fungerer korrekt. Ellers klik på <span class="guibutton"><strong>Brug forrige indstillinger</strong></span>. Hvis du ikke vælger noget inden for 20 sekunder, vil systemet vende tilbage til de tidligere indstillinger.</p>
                </div>
              </div>
            </div>
          </div>

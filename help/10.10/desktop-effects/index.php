...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Visuelle effekter</title>
    ...
    <link rel="next" href="compiz-intro.php" title="Hvad er visuelle effekter?" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Visuelle effekter</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Visuelle effekter" lang="da">
                </div>
              </div>
            </div>
          </div>

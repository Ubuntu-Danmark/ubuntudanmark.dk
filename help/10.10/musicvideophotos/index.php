...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Musik, video og fotos</title>
    ...
    <link rel="next" href="music.php" title="Kapitel 1. Musik" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Musik, video og fotos</h1>
              <div class="entry-content">
                <div xml:lang="da" class="book" title="Musik, video og fotos" lang="da">
                </div>
              </div>
            </div>
          </div>

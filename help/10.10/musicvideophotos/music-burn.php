...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kopiér til en cd</title>
    ...
    <link rel="prev" href="music-extract.php" title="Udtrække fra en cd" />
    <link rel="next" href="music-portable.php" title="Transportable musikafspillere" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kopiér til en cd</h1>
              <div class="entry-content">
                <div class="sect1" title="Kopiér til en cd">
                  <p>Du kan oprette din egne lyd-cd ved at kopiere musik fra din computer ud på en tom disk. Cd'er som du opretter på denne måde bør kunne afspilles i enhver standardenhed som kan afspille købecd'er. Det eneste, som kræves, er en cd-brænder. De fleste computere har en cd-brænder.</p>
                  <p>For at begynde med at lave en lyd-cd, skal du starte Brasero (<span class="guimenu">Programmer</span> → <span class="guimenuitem">Lyd &amp; Video</span> → <span class="guimenuitem">Brasero diskbrænder</span>) og vælg <span class="guibutton"><strong>Lydprojekt</strong></span> fra hovedvinduet. Vælg derefter de sange, du vil føje til cd'en og tilføje dem til projektet. Endelig skal du klikke på <span class="guibutton"><strong>Brænd...</strong></span> for at kopiere sangene til en cd.</p>
                  <p>Du vil også skulle indstille den maksimale varighed på cd'en, du har indsat (for eksempel 80 minutter), hvilket kan gøres ved at klikke på det lille cd-ikon nær bunden af vinduet. Brasero vil advare dig, hvis du har valgt flere filer, end der kan være på disken.</p>
                  <p>Se <a class="ulink" href="http://library.gnome.org/users/brasero/2.32/" target="_top"> Brasero manual</a> for fyldestgørende instruktioner.</p>
                </div>
              </div>
            </div>
          </div>

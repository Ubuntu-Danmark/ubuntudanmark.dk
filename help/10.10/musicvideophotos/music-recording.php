...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="prev" href="music-download.php" title="Hent musik på internettet" />
    <link rel="next" href="music-microphone.php" title="Min mikrofon virker ikke eller er for lav" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Optag lyd</h1>
              <div class="entry-content">
                <div class="sect1" title="Optag lyd">
                  <p>Du kan optage lyd på din computer, hvis du har en mikrofon eller anden optagelsesudstyr forbundet med den.</p>
                  <p>Tryk på <span class="guimenu">Programmer</span> → <span class="guimenuitem">Lyd &amp; Video</span> → <span class="guimenuitem">Lydoptager</span> for at starte et simpelt lydoptagerprogram. Læs <a class="ulink" href="http://library.gnome.org/users/gnome-sound-recorder/2.32/" target="_top">Lydoptager manualen</a> for instruktioner om, hvordan man bruger dette.</p>
                  <p>For mere avancerede optagelsesbehov kan du forsøge dig med et lydprogram til flersporshåndtering såsom <a class="ulink" href="apt:jokosher" target="_top">Jokosher</a> eller <a class="ulink" href="apt:audacity" target="_top">Audacity</a>.</p>
                  <p>Mange andre optagelsesværktøjer på professionelt niveau er tilgængelig i Ubuntu. Se <a class="ulink" href="http://ubuntustudio.org/" target="_top"> Ubuntu Studio website</a> for yderligere information.</p>
                </div>
              </div>
            </div>
          </div>

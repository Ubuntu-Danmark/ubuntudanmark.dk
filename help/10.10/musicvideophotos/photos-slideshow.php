...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Se et diasshow af dine billeder</title>
    ...
    <link rel="prev" href="photos-organize.php" title="Organiser din billedsamling" />
    <link rel="next" href="photos-printing.php" title="Udskriv billeder" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Se et diasshow af dine billeder</h1>
              <div class="entry-content">
                <div class="sect1" title="Se et diasshow af dine billeder">
                  <p>Hvis du ønsker at vise dine billeder i al deres gloværdigged, hvorfor så ikke gøre det i et diasshow?</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>Se et diasshow ved brug af <a class="ulink" href="http://library.gnome.org/users/eog/2.32/eog-view.html#eog-fullscreen" target="_top"> gThump - billedfremviseren</a></p>
                      </li>
                      <li class="listitem">
                        <p>Se et diasshow ved brug af <a class="ulink" href="http://f-spot.org/User_Guide/Enjoy#Slideshow_and_Fullscreen_Modes" target="_top"> F-Spot - fotohåndtering</a></p>
                      </li>
                    </ul>
                  </div>
                  <div class="sect2" title="Indstil et diasshow som din pauseskærm">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="photos-slideshow-screensaver"></a>Indstil et diasshow som din pauseskærm</h3>
                        </div>
                      </div>
                    </div>
                    <p>Du kan bruge et diasshow af dine billeder som din pauseskærm:</p>
                    <div class="orderedlist">
                      <ol class="orderedlist" type="1">
                        <li class="listitem">
                          <p>Tryk <span class="guimenu">System</span> → <span class="guimenuitem">Indstillinger</span> → <span class="guimenuitem">Pauseskærm</span></p>
                        </li>
                        <li class="listitem">
                          <p>Vælg tema for pauseskærm <em class="guilabel">F-Spot fotos</em></p>
                        </li>
                        <li class="listitem">
                          <p>Billeder som er mærket <em class="guilabel">Favoritter</em> i <span class="application"><strong>F-Spot - fotohåndtering</strong></span> vil blive vist som din pauseskærm</p>
                        </li>
                      </ol>
                    </div>
                    <p>Hvis du ønsker at ændre det mærke som bruges til diasshowet:</p>
                    <div class="orderedlist">
                      <ol class="orderedlist" type="1">
                        <li class="listitem">
                          <p>Åbn F-Spot</p>
                        ...
                        <li class="listitem">
                          <p>Tryk <span class="guimenuitem">Rediger</span> → <span class="guimenuitem">Indstillinger</span></p>
                        </li>
                        <li class="listitem">
                          <p>Under <em class="guilabel">Pauseskærm</em>, vælg det ønskede mærke</p>
                        </li>
                        <li class="listitem">
                          <p>Tryk <span class="guibutton"><strong>Luk</strong></span></p>
                        </li>
                      </ol>
                    </div>
                  </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Introduktion</title>
    ...
    <link rel="prev" href="index.php" title="Opret en USB-opstartsdisk" />
    <link rel="next" href="requirements.php" title="Krav" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Introduktion</h1>
              <div class="entry-content">
                <div class="sect1" title="Introduktion">
                  <p><span class="application"><strong>Opret en USB-opstartsdisk</strong></span> er et værktøj i Ubuntu, der skaber et blivende Ubuntu-aftryk på en USB-disk. Dette kaldes en "live-USB". Du kan bruge live-USB'en til at installere Ubuntu på din computer eller til at køre Ubuntu, uden at det påvirker dit systems hardware. Fordelene ved at bruge en live-USB frem for at installere eller afprøve Ubuntu er bl.a.: </p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p>Mindre affald. En live-USB kan overskrives, når der udkommer en ny version af Ubuntu.</p>
                      </li>
                      <li class="listitem">
                        <p>Blivende. I modsætning til en live-cd gemmes ændringer til USB-disken.</p>
                      </li>
                      <li class="listitem">
                        <p>Intet cd-drev er nødvendigt. Computere, der mangler et cd-drev har som regel et USB-drev.</p>
                      </li>
                      <li class="listitem">
                        <p>Sikkert computermiljø. Start din computer fra en live-USB for at beskytte dit system, når du forbinder til usikre offentlige net, eller hvis du tester ustabil funktionalitet.</p>
                      </li>
                    </ul>
                  </div>
                </div>

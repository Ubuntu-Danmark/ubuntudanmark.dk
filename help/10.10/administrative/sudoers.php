...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Tildel en bruger administrativ adgang</title>
    ...
    <link rel="prev" href="index.php" title="Administrative opgaver" />
    <link rel="next" href="terminal.php" title="Brug sudo i kommandolinjen" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Tildel en bruger administrativ adgang</h1>
              <div class="entry-content">
                <div class="sect1" title="Tildel en bruger administrativ adgang">
                  <p>Du kan begrænse og aktivere administrativ adgang (sudo) til brugere via programmet <a class="ulink" href="http://library.gnome.org/users/users-admin/2.32/" target="_top">Brugere og grupper</a>:</p>
                  <div class="procedure">
                    <ol class="procedure" type="1">
                      <li class="step" title="Trin 1">
                        <p>Klik <span class="guimenu">System</span> → <span class="guimenuitem">Administration</span> → <span class="guimenuitem">Brugere og grupper</span></p>
                      </li>
                      <li class="step" title="Trin 2">
                        <p>Vælg den bruger som skal gives administrativ adgang og klik på <span class="guibutton"><strong>Avanverede indstillinger</strong></span></p>
                      </li>
                      <li class="step" title="Trin 3">
                        <p>Hvis du bliver spurgt, skal du indtaste din adgangskode og trykke på <span class="guibutton"><strong>Godkend</strong></span>.</p>
                      </li>
                      <li class="step" title="Trin 4">
                        <p>Vælg fanebladet <em class="guilabel">Brugerrettigheder</em></p>
                      </li>
                      <li class="step" title="Trin 5">
                        <p>Sæt flueben i boksen ved <em class="guilabel">Administrér systemet</em> og tryk <span class="guibutton"><strong>O.k.</strong></span></p>
                      </li>
                    </ol>
                  </div>
                </div>

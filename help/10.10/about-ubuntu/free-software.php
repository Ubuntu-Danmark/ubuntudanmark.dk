...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Fri software</title>
    ...
    <link rel="prev" href="about-ubuntu-name.php" title="Om navnet" />
    <link rel="next" href="ubuntu-difference.php" title="Forskellen" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Fri software</h1>
              <div class="entry-content">
                <div class="sect1" title="Fri software">
                  <p>Ubuntu støtter helhjertet principperne bag fri softwareudvikling. Vi opfordrer folk til at bruge fri software, forbedre det og give det videre.</p>
                  <p>"Fri software" betyder ikke, at du ikke skal betale for det (selvom Ubuntu lægger vægt på også at være gratis). Det betyder, at du skal kunne bruge softwaren på en hvilken som helst måde, du ønsker: Den programkode, som fri software består af, er tilgængelig for alle, og man har ret til at hente, ændre, rette og bruge den, som man vil. Foruden de ideologiske fordele har denne frihed også tekniske fordele: Når programmer bliver udviklet, kan man bruge andres hårde arbejde og bygge videre på det. Det kan man ikke med ikke-fri software, så når programmer skal udvikles, er de nødt til at starte fra bunden. Derfor er udviklingen af fri software hurtig, effektiv og spændende!</p>
                  <p>Du kan læse mere om fri software og den ideologiske og tekniske filosofi bag konceptet på <a class="ulink" href="http://www.gnu.org/philosophy/" target="_top">GNU's websted</a>.</p>
                </div>
              </div>
            </div>
          </div>

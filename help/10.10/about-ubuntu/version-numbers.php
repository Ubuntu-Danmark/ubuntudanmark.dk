...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Versions- og udgivelsesnumre</title>
    ...
    <link rel="prev" href="ubuntu-desktop.php" title="Skrivebordsmiljøet" />
    <link rel="next" href="ubuntu-backing-support.php" title="Opbakning og support" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Versions- og udgivelsesnumre</h1>
              <div class="entry-content">
                <div class="sect1" title="Versions- og udgivelsesnumre">
                  <p>Ubuntus system til nummerering af versioner er baseret på den dato, vi udgiver en ny distributionsversion. Versionsnummeret kommer fra året og måneden for udgivelsen i stedet for at afspejle softwarens reelle version.</p>
                  <p>Vores første udgivelse (Warty Warthog) blev udgivet i oktober 2004, så dens version var 4.10. Den nuværende version (Maverick Meerkat) blev udgivet i oktober 2010, så dens versionsnummer er 10.10.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Ny bruger af Ubuntu?</title>
    ...
    <link rel="next" href="welcome.php" title="Velkommen til Ubuntu" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Ny bruger af Ubuntu?</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Ny bruger af Ubuntu?" lang="da">
                  <p>Hvis Ubuntu er nyt for dig, vil denne sektion hjælpe dig med at blive bekendt med skrivebordet, udføre nogle simple opgaver, og vise dig hvor du kan få yderligere hjælp.</p>
                </div>
              </div>
            </div>
          </div>

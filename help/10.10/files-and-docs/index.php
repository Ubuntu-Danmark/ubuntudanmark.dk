...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Filer, mapper og dokumenter</title>
    ...
    <link rel="home" href="index.html" title="Filer, mapper og dokumenter" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Filer, mapper og dokumenter</h1>
              <div class="entry-content">
                <div xml:lang="da" class="article" title="Filer, mapper og dokumenter" lang="da">
                  <p>Dette afsnit indeholder råd og hjælp til at arbejde med filer og mapper.</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p><span class="strong"><strong>
			<a class="ulink" href="http://library.gnome.org/users/user-guide/2.32/nautilus.html" target="_top">Arbejde med filer</a></strong></span>
		</p>
                        <p>Vejledninger i at arbejde med filer og mapper i filhåndteringen</p>
                      </li>
                      <li class="listitem">
                        <p><span class="strong"><strong>
			<a class="ulink" href="../office/" target="_top">Kontorprogrammer og dokumenter</a></strong></span>
		</p>
                        <p>Information om kontorprogrammer, for eksempel tekstbehandlingsprogrammer og regneark</p>
                      </li>
                      <li class="listitem">
                        <p><span class="strong"><strong>
			<a class="ulink" href="../hardware/disks.php" target="_top">Diske, partitionering og formatering</a></strong></span>
		</p>
                        <p>Hjælp til at bruge flytbare diske</p>
                      </li>
                    </ul>
                  </div>
                </div>

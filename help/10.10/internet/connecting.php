...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 2. Måder at forbinde på</title>
    ...
    <link rel="prev" href="networkmanager.php" title="Kapitel 1. Opret forbindelse til internettet eller et netværk" />
    <link rel="next" href="connecting-wired.php" title="Kablet (LAN)" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 2. Måder at forbinde på</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 2. Måder at forbinde på">
                  <p>Kablede, trådløse, mobile bredbånds-, VPN- og DSL-forbindelser understøttes i Ubuntu i Netværkshåndteringen. Opkaldsmodem-forbindelser er ikke understøttet, men du kan muligvis selv få en op at køre; se <a class="xref" href="modem.php" title="Kapitel 6. Modemmer">Kapitel 6, <i>Modemmer</i></a>.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Design web-sider</title>
    ...
    <link rel="prev" href="internet-otherapps.php" title="Andre internetprogrammer" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Design web-sider</h1>
              <div class="entry-content">
                <div class="sect1" title="Design web-sider">
                  <p>Ubuntu inkluderer et bredt udvalg af værktøjer til at hjælpe dig med at designe og udvikle hjemmesider.</p>
                  <div class="itemizedlist">
                    <ul class="itemizedlist" type="disc">
                      <li class="listitem">
                        <p><span class="strong"><strong><span class="application"><strong>Bluefish</strong></span></strong></span> er en funktionsrig editor for web-designere og programmører.</p>
                        <p><span class="application"><strong>Bluefish</strong></span> understøtter mange programmerings- og kodesprog, og indeholder mange værktøjer til designere og programmører.</p>
                        <div class="itemizedlist">
                          <ul class="itemizedlist" type="circle">
                            <li class="listitem">
                              <p>Se <a class="ulink" href="http://bluefish.openoffice.nl/" target="_top">Bluefish-hjemmesiden</a> for yderligere information.</p>
                            </li>
                            <li class="listitem">
                              <p><a class="ulink" href="apt:bluefish" target="_top">Installer pakken <span class="application"><strong>bluefish</strong></span></a>.</p>
                            </li>
                            <li class="listitem">
                              <p>For at starte Bluefish, skal du trykke <span class="guimenu">Programmer</span> → <span class="guimenuitem">Programmering</span> → <span class="guimenuitem">Bluefish Editor</span>.</p>
                            </li>
                          </ul>
                        </div>
                      </li>

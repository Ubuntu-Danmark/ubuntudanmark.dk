...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 3. Frakobling</title>
    ...
    <link rel="prev" href="connecting-dsl.php" title="DSL" />
    <link rel="next" href="information.php" title="Kapitel 4. Information om din forbindelse" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 3. Frakobling</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 3. Frakobling">
                  <p>Klik på ikonet for Netværkshåndteringen og vælg <em class="guilabel">Afbryd</em> under navnet på den aktive forbindelse, for at afbryde forbindelsen til et netværk.</p>
                  <p>Højreklik på ikonet for Netværkshåndteringen og fjern markeringen ud for <em class="guilabel">Aktivér Netværk</em>, for at deaktivere en netværksforbindelse (så der ikke kan oprettes forbindelse).</p>
                  <p>Du kan slukke for din trådløse forbindelse ved at højreklikke på Netværkshåndteringen og fjerne flueben ved <em class="guilabel">Aktivér trådløst netværk</em>. Nogle bærbare computere har også en knap eller en tastekombination, som du kan trykke for at slukke for forbindelsen. Dette er nyttigt hvis du bruger din bærbare computer i et fly eller et andet sted hvor trådløse enheder ikke er tilladt.</p>
                </div>
              </div>
            </div>
          </div>

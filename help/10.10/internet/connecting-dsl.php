...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="prev" href="connecting-vpn.php" title="Virtuelle private netværk" />
    <link rel="next" href="disconnecting.php" title="Kapitel 3. Frakobling" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">DSL</h1>
              <div class="entry-content">
                <div class="sect1" title="DSL">
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      ...
                      <li class="listitem">
                        <p>Klik på <em class="guilabel">DSL</em>.</p>
                      </li>
                      <li class="listitem">

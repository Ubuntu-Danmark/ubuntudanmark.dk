...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 1. Opret forbindelse til internettet eller et netværk</title>
    ...
    <link rel="prev" href="index.php" title="Internet og netværk" />
    <link rel="next" href="connecting.php" title="Kapitel 2. Måder at forbinde på" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 1. Opret forbindelse til internettet eller et netværk</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 1. Opret forbindelse til internettet eller et netværk">
                  <p>Brug panelprogrammet Netværkshåndtering, i det øverste panel, for opsætning af forbindelsen til dit netværk og internettet. Panelprogrammet vil ændre udseende afhængigt af hvilken type forbindelse du har; det kan for eksempel se ud som en trådløs antenne eller to pile. Kig nær uret for at finde det.</p>
                  <p>Venstreklik på ikonet for Netværkshåndteringen og vælg et netværk fra listen, hvis du vil forbinde til et netværk.</p>
                  <p>Hvis du ikke kan se et netværk på listen, eller vil se eller ændre nogle netværksindstillinger, så højreklik på ikonet for Netværkshåndteringen og vælg den relevante indstilling.</p>
                  <p>Se <a class="xref" href="connecting.php" title="Kapitel 2. Måder at forbinde på">Kapitel 2, <i>Måder at forbinde på</i></a> for specifikke instruktioner i at forbinde til et netværk.</p>
                </div>
              </div>
            </div>
          </div>

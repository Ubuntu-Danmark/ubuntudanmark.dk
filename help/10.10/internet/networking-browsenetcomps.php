            ...
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              ...
              <div class="entry-content">
                <div class="sect1" title="Se andre computere på netværket">
                  ...
                  <p>Se <a class="ulink" href="http://library.gnome.org/users/user-guide/2.32/nautilus-accessnetwork.html" target="_top">Navigering af fjernservere</a> for yderligere information.</p>
                </div>
              </div>
            </div>
          </div>

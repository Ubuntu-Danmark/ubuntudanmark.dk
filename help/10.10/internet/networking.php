...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Kapitel 8. Hjemmenetværk</title>
    ...
    <link rel="prev" href="connecttoserver-custom.php" title="Tilpasset" />
    <link rel="next" href="networking-browsenetcomps.php" title="Se andre computere på netværket" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kapitel 8. Hjemmenetværk</h1>
              <div class="entry-content">
                <div class="chapter" title="Kapitel 8. Hjemmenetværk">
                  <p>Dette afsnit giver instruktioner om hvordan man kan kommunikere med andre computere ved hjælp af et lokalnetværk.</p>
                </div>
              </div>
            </div>
          </div>

...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="prev" href="connecting.php" title="Kapitel 2. Måder at forbinde på" />
    <link rel="next" href="connecting-wireless.php" title="Trådløs" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Kablet (LAN)</h1>
              <div class="entry-content">
                <div class="sect1" title="Kablet (LAN)">
                  <p>Du vil automatisk blive forbundet til et kablet netværk når du indsætter netværkskablet.</p>
                  <p>Hvis du ikke er forbundet, er det muligt at dit netværk ikke har en DHCP-server (DHCP er ansvarlig for at tildele netværksindstillinger). I dette tilfælde vil det være nødvendigt at du selv indtaster dine netværksindstillinger.</p>
                  <div class="sect2" title="Manuel indtastning af din netværksopsætning">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="connecting-wired-manual"></a>Manuel indtastning af din netværksopsætning</h3>
                        </div>
                      </div>
                    </div>
                    <p>Hvis du ikke har DHCP på dit netværk, kan du konfigurere en statisk forbindelse. Du vil få brug for at indtaste netværksopsætningen selv, så spørg din netværksadministrator eller se på din ruters opsætning for at få de oplysninger du har brug for.</p>
                    <div class="orderedlist">
                      <ol class="orderedlist" type="1">
                        ...
                        <li class="listitem">
                          <p>Klik på fanen <em class="guilabel">Kablet</em>, vælg forbindelsen og klik på <span class="guibutton"><strong>Redigér</strong></span>.</p>
                        </li>
                        <li class="listitem">
                          <p>Klik på fanen <em class="guilabel">IPv4-indstillinger</em> og vælg <em class="guilabel">Manual</em> fra listen <em class="guilabel">Metode</em>.</p>
                        </li>
                        <li class="listitem">
                          <p>Tryk <span class="guibutton"><strong>Tilføj</strong></span> og indtast din IP-adresse samt andre oplysninger. Indtast også adressen for din DNS-server.</p>
                        </li>
                        <li class="listitem">
                          <p>Tryk på <span class="guibutton"><strong>Anvend</strong></span>. Hvis du har indtastet de rigtige indstillinger, skulle forbindelsen til netværket nu blive oprettet.</p>
                        </li>
                      </ol>
                    </div>
                  </div>

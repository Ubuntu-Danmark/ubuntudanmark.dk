...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Send og modtag e-post</title>
    ...
    <link rel="prev" href="web-browsing.php" title="På nettet med Firefox" />
    <link rel="next" href="internet-instant-messaging.php" title="Chat" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Send og modtag e-post</h1>
              <div class="entry-content">
                <div class="sect1" title="Send og modtag e-post">
                  <p>E-post er en af de mest populære måder at kommunikere over internettet. Ubuntu indeholder alle de værktøjer, du har brug for, når du skal sende, modtage og organisere e-post.</p>
                  <p><span class="application"><strong>Evolution</strong></span> er standardprogrammet til e-post og det kan opfylde alle dine behov for håndtering af <a class="ulink" href="http://library.gnome.org/users/evolution/2.32/usage-mail.html" target="_top">e-post</a>, <a class="ulink" href="http://library.gnome.org/users/evolution/2.32/usage-contact.html" target="_top">kontaktpersoner</a>, <a class="ulink" href="http://library.gnome.org/users/evolution/2.32/usage-calendar-todo.html" target="_top">opgaver</a> og <a class="ulink" href="http://library.gnome.org/users/evolution/2.32/usage-calendar.html" target="_top">kalendere</a>. Evolution er integreret med <a class="ulink" href="http://library.gnome.org/users/clock/2.32/" target="_top">uret i panelet</a>, hvilket giver dig adgang til din opgaveliste med ét enkelt klik.</p>
                  <p><span class="application"><strong>Evolution</strong></span> kan åbnes ved at klikke på <span class="guimenu">Programmer</span> → <span class="guimenuitem">Kontor</span> → <span class="guimenuitem">Evolution E-post og Kalender</span>.</p>
                  <p>Læs <a class="ulink" href="http://library.gnome.org/users/evolution/2.32/" target="_top">manualen til Evolution</a> for at få hjælp med at bruge Evolution.</p>
                  <div class="sect2" title="Filtrering af spam">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="email-evolution-spam"></a>Filtrering af spam</h3>
                        </div>
                      </div>
                    </div>
                    <p>Bogofilter klassificerer post som uønsket post (også kendt som <span class="emphasis"><em>spam</em></span>) ved at analysere beskeden statistisk, og kan lære af valg foretaget af brugeren. Denne teknik kaldes Bayesian-filtrering, du kan finde flere informationer om dette her:</p>
                    <div class="itemizedlist">
                      <ul class="itemizedlist" type="disc">
                        <li class="listitem">
                          <p>
                            <a class="ulink" href="http://www.paulgraham.com/spam.html" target="_top">http://www.paulgraham.com/spam.html</a>
                          </p>
                        </li>
                        <li class="listitem">
                          <p>
                            <a class="ulink" href="http://www.paulgraham.com/better.html" target="_top">http://www.paulgraham.com/better.html</a>
                          </p>
                        </li>
                      </ul>
                    </div>
                    <p>Evolution kan automatisk konfigureres til at bruge Bogofilter.</p>
                    <div class="itemizedlist">
                      <ul class="itemizedlist" type="disc">
                        <li class="listitem">
                          <p><a class="ulink" href="apt:bogofilter" target="_top">Installer pakken <span class="application"><strong>Bogofilter</strong></span></a>.</p>
                        </li>
                        <li class="listitem">
                          <p>Åbn <span class="guimenu">Programmer</span> → <span class="guimenuitem">Kontor</span> → <span class="guimenuitem">Evolution E-post og Kalender</span>.</p>
                        </li>
                        <li class="listitem">
                          <p>Aktiver spam-filter ved at vælge <span class="guimenuitem">Redigér</span> → <span class="guimenuitem">Indstillinger</span> → <span class="guimenuitem">E-post-indstillinger</span> → <span class="guimenuitem">Spam</span> → <span class="guimenuitem">Kontrollér indgående post for spam</span>.</p>
                        </li>
                        <li class="listitem">
                          <p>Tænd Bogofilter-udvidelsen ved at vælge <span class="guimenuitem">Redigér</span> → <span class="guimenuitem">Udvidelsesmoduler</span>.</p>
                        </li>
                      </ul>
                    </div>
                    <p>Bogofilter vil nu begynde at lære hvad der er spam, baseret på de beskeder du markerer. For at markere en meddelelse som spam, skal du vælge <span class="guimenuitem">Besked</span> → <span class="guimenuitem">Markér som</span> → <span class="guimenuitem">Spam</span>.</p>
                  </div>
                  <div class="sect2" title="Alternative e-post-programmer">
                    <div class="titlepage">
                      <div>
                        <div>
                          <h3 class="title"><a id="email-alternative"></a>Alternative e-post-programmer</h3>
                        </div>
                      </div>
                    </div>
                    <p>Du kan også bruge <span class="application"><strong>Mozilla Thunderbird</strong></span> til e-post. <a class="ulink" href="apt:thunderbird" target="_top">Installer pakken <span class="application"><strong>thunderbird</strong></span></a>.</p>
                    <p>For at starte <span class="application"><strong>Thunderbird</strong></span>, vælg <span class="guimenu">Programmer</span> → <span class="guimenuitem">Internet</span> → <span class="guimenuitem">Mozilla Thunderbird Mail/Nyheder</span>.</p>
                    <p>At skifte til <span class="application"><strong>Mozilla Thunderbird</strong></span> som dit foretrukne e-post-program:</p>
                    <div class="procedure">
                      <ol class="procedure" type="1">
                        <li class="step" title="Trin 1">
                          <p>Vælg <span class="guimenu">System</span> → <span class="guimenuitem">Indstillinger</span> → <span class="guimenuitem">Foretrukne programmer</span></p>
                        </li>
                        <li class="step" title="Trin 2">
                          <p>Klik på rullegardinmenuen <span class="guibutton"><strong>Postprogram</strong></span> og vælg <em class="guilabel">Thunderbird</em>.</p>
                        </li>
                        <li class="step" title="Trin 3">
                          <p>Hvis Thunderbird ikke er nævnt ovenfor, så klik på indstillingen <em class="guilabel">Tilpasset</em>. Skriv <span class="command"><strong>Thunderbird %s</strong></span> i tekstboksen Kommando og <span class="guibutton"><strong>Luk</strong></span>.</p>
                        </li>
                      </ol>
                    </div>
                  </div>

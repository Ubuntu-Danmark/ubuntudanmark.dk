...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    ...
    <link rel="prev" href="connecttoserver-webdav.php" title="WebDAV (HTTP)" />
    <link rel="next" href="networking.php" title="Kapitel 8. Hjemmenetværk" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Tilpasset</h1>
              <div class="entry-content">
                <div class="sect1" title="Tilpasset">
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      ...
                      <li class="listitem">
                        <p>Vælg <em class="guilabel">Brugerdefineret sted</em> fra <em class="guilabel">Tjenestetype</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Indtast adressen på serveren i <em class="guilabel">Placering (URI)</em>.</p>
                      </li>
                      <li class="listitem">

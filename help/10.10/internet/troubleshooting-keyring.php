...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="da-DK" xml:lang="da-DK">
  <head>
    <title xmlns="">Hvorfor spørger Gnome Nøglering om min adgangskode hver gang jeg logger ind?</title>
    ...
    <link rel="prev" href="troubleshooting-mobile.php" title="Fejlfinding for mobil bredbånd" />
    <link rel="next" href="modem.php" title="Kapitel 6. Modemmer" />
  </head>
        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Hvorfor spørger Gnome Nøglering om min adgangskode hver gang jeg logger ind?</h1>
              <div class="entry-content">
                <div class="sect1" title="Hvorfor spørger Gnome Nøglering om min adgangskode hver gang jeg logger ind?">
                  <p>Du vil muligvis blive spurgt om din adgangskode hver gang du logger ind for at du kan forbinde til et netværk. Du kan forhindre dette således:</p>
                  <div class="orderedlist">
                    <ol class="orderedlist" type="1">
                      <li class="listitem">
                        <p>Højreklik på ikonet for <span class="guiicon">Netværkshåndteringen</span> og vælg <em class="guilabel">Redigér forbindelser...</em>.</p>
                      </li>
                      <li class="listitem">
                        <p>Gå til fanen <em class="guilabel">Trådløs</em>, vælg forbindelsen du benytter, og klik på <span class="guibutton"><strong>Redigér</strong></span>.</p>
                      </li>
                      <li class="listitem">
                        <p>Markér <em class="guilabel">Tilgængelig for alle brugere</em> og tryk på <span class="guibutton"><strong>Anvend</strong></span>. Indtast din adgangskode om nødvendigt.</p>
                      </li>
                    </ol>
                  </div>
                  <p>Næste gang du logger ind, burde det ikke være nødvendigt at indtaste din adgangskode for at forbinde til din netværksforbindelse.</p>
                </div>
              </div>
            </div>
          </div>

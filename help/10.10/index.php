        ...
        <div id="container">
          <div id="content">
            <div class="page type-page hentry" style="-moz-border-radius: 5px 5px 5px 5px;">
              <h1 class="entry-title">Hjælp for Ubuntu 10.10</h1>
              <div class="entry-content">
                <p>Her kan du finde hjælp til den seneste udgave af Ubuntu.
                </p>
          ...
          <ul class="xoxo">
            <li class="widgetcontainer widget" id="">
              ...
              <ul>
                ...
                <li><a href="/help/10.10/software-center/">Ubuntu Softwarecenter</a></li>
              </ul>
            </li>
          </ul>
        </div>
